...
Public Class rep_account_profitability
...
#End Region
    ...
    Public strSubMenuName As String = "rep_account_profitability"
    Public strStoredProc As String = "rep_account_profitability"
    Public strSubMenuFullView As String = "rep_account_profitability_popup"
    ...
    Public strFileNameExcel As String = "AccountProfitabilityReport.xls"
    Public strFileNamePDF As String = "AccountProfitabilityReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            calDateTo.SelectedDate = DateTime.UtcNow.AddHours(8).ToShortDateString
