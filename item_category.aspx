<%@ Page Language="vb" aspcompat="true" EnableEventValidation="false" AutoEventWireup="true" Codebehind="item_category.aspx.vb" Inherits="srx.item_category" %>

<!DOCTYPE html>
<html>
<head>
<title>EMS Shop | Item Category</title>
		...
		<div class="breadcrumbs w3-large">
			<div class="container">
				<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
					...
					<li class="active"><asp:label id="lblCategoryName" runat="server"></asp:label></li>
				</ol>
			</div>
		</div>
		<!--//breadcrumbs-->
