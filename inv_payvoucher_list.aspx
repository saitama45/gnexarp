<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_payvoucher_list.aspx.vb" Inherits="srx.inv_payvoucher_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;AP Voucher</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						...
						<DIV class="w3-section w3-medium">
							<%response.write("<a class='w3-hover-blue' href='inv_payvoucher_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							...
							<div class="w3-row">
								...
								<div class="w3-half">
									<div class="w3-container">
										<LABEL><B>Date Incurred</B></LABEL><BR>
