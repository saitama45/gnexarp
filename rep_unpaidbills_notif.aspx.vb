...
Public Class rep_unpaidbills_notif
...
#End Region
    ...
    Public strSubMenuName As String = "ref_unpaidbills_notif"
    Public strStoredProc As String = "rep_unpaidbills_notif"
    Public strSubMenuFullView As String = "rep_unpaidbills_notif_popup"
    ...
    Public strFileNameExcel As String = "UnpaidBillsReport.xls"
    Public strFileNamePDF As String = "UnpaidBillsReport.pdf"
