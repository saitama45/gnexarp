<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_receiving_nonpoa.aspx.vb" Inherits="srx.inv_receiving_nonpoa" %>
...
<HTML>
	...
	<!-- #include file ="html\BodyColor.html" -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0;" runat="server" Visible="False">
					...
					<DIV id="id01" class="w3-card-4" style="margin: auto; MAX-WIDTH: 600px">
						...
						<DIV class="w3-section w3-medium">
							<%response.write("<a class='w3-hover-blue' href='inv_receiving_nonpoa'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
		...
		<script>                        
			...
			$('#txtDiscount,#txtTerms').on('input', function(event) {
