...
Public Class rep_available_stocks
...
#End Region
    ...
    Public strSubMenuName As String = "rep_available_stocks"
    Public strStoredProc As String = "rep_available_stocks"
    Public strSubMenuFullView As String = "rep_available_stocks_popup"
    ...
    Public strFileNameExcel As String = "AvailableStocksReport.xls"
    Public strFileNamePDF As String = "AvailableStocksReport.pdf"
