...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblIssuedTo As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strSubMenuName As String = "inv_dr_approval"
    Public strStoredProc As String = "inv_dr_approval"
    Public strStoredProc2 As String = "Inv_IssuedItems_List"
    Public strStoredProcPageCount As String = "Inv_DRApprovalPageCount_Get"
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_DRApproval_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Approve" Then
            ...
            lblIssuedTo.Text = Trim(objReader("dest_st"))
            lblIssuedTo.Visible = True
