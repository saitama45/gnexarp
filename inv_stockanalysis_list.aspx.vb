...
Public Class inv_stockanalysis_list
...
#End Region
    ...
    Public strSubMenuName As String = "inv_stockanalysis_list"
    Public strStoredProc As String = "inv_stockanalysis_list"
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_stockanalysisitems_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
