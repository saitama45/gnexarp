...
#End Region
    ...
    Public strSubMenuName As String = "inv_paid_list"
    Public strStoredProc As String = "inv_paid_list"
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_paiddtl_list?&id=" & Session("objNewID") & "&or_no=" & txtORNo.Text & "&customer=" & ddlCustomer.SelectedValue)                    
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_paiddtl_list?&id=" & strKeyFieldValue & "&or_no=" & txtORNo.Text & "&customer=" & ddlCustomer.SelectedValue)
