...
#End Region
    ...
    Public strSubMenuName As String = "inv_returns_list"
    Public strStoredProc As String = "inv_returns_list"
    Public strStoredProcPageCount As String = "Inv_ReturnsPageCount_Get"
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_returnitems_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_returnitems_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
    ...
    Private Sub Refresh_Destination()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))
        objConnection.Open()
        Dim objCommand As New SqlCommand("Ref_ReturnVendors_Get_droplist", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
