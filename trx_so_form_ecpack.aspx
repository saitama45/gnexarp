<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_so_form_ecpack.aspx.vb" Inherits="srx.trx_so_form_ecpack" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.pr_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 59em; TOP: 74px }
			...
			LABEL.vat { FONT-SIZE: 12px; MARGIN-LEFT: 55em; width: 90px; display: inline-block;}
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				<div class="image_header">
					<img src="./images/soform_ctems.jpg" alt="receivingform" class="img_background" >
				...
				<div class="printed_on" style="display:none">
					Printed On:
						...
						<td>
							<div class="page">
								...
								<div class="datagrid">
									...
									<div class="vat" style="display:none">
										<label class="vat">VAT:</label>
