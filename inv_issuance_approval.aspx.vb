...
Public Class inv_issuance_approval
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblDRNum As System.Web.UI.WebControls.Label
    Protected WithEvents lblDRNetAmount As System.Web.UI.WebControls.Label
    Protected WithEvents lblSINum As System.Web.UI.WebControls.Label
    Protected WithEvents lblDateDelivered As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strSubMenuName As String = "inv_issuance_list"
    Public strStoredProc As String = "inv_issuance_approval"
    Public strStoredProc2 As String = "Inv_DRItems_List"
    Public strStoredProc3 As String = "Inv_PrintPreview_SIForm_COSMOMED"
    Public strStoredProcPageCount As String = "Inv_IssuanceApprovalPageCount_Get"
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_IssuanceApproval_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        If chbNoExpiryDate.Checked = True Then
            objCommand.Parameters.Add("@delivery_date", calDeliveryDate.SelectedDate)
        Else
            objCommand.Parameters.Add("@delivery_date", "1/1/1999")
        End If

        objCommand.Parameters.Add("@dr_code", lblDRNum.Text)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Approve" Then
            ...
            lblFirstname.Text = Trim(objReader("firstname"))
            lblLastname.Text = Trim(objReader("lastname"))
            lblFullname.Text = Trim(objReader("Fullname"))
            lblPayType.Text = Trim(objReader("pay_type"))
            lblCartTotalShow.Text = Trim(objReader("cart_total"))
            lblShippingFeeShow.Text = Trim(objReader("shipping_fee"))
            lblOrderTotalShow.Text = Trim(objReader("grand_total"))

            lblID.Text = Trim(objReader("id"))
            lblDRNum.Text = Trim(objReader("dr_code"))
            lblDRNum.Visible = True

            lblSINum.Text = Trim(objreader("invoice_no"))
            lblSINum.Visible = True

            lblDRNetAmount.Text = Trim(objReader("net_amount"))
            lblDRNetAmount.Visible = True

            chbNoExpiryDate.Checked = False
            lblDateDelivered.Visible = False
            calDeliveryDate.Visible = False

            If objReader("delivery_date") = "1/1/1900" Then
                calDeliveryDate.SelectedDate = Date.UtcNow.AddHours(8).ToShortDateString()
            Else
    ...
    Private Sub DataGrid2_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles DataGrid2.ItemCreated
        ...
        If Session("company_code") = "COSMOMED" Then
            Dim aColumns() As String = {"sku_code", _
                                                "item_desc", _
                                                "qty", _
                                                "unit_cost", _
                                                "total_cost", _
    ...
    Private Sub chbNoExpiryDate_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chbNoExpiryDate.CheckedChanged
        If chbNoExpiryDate.Checked = True Then
            lblDateDelivered.Visible = True
            calDeliveryDate.Visible = True
            calDeliveryDate.Enabled = True
        Else
            lblDateDelivered.Visible = False
            calDeliveryDate.Visible = False
            calDeliveryDate.Enabled = False
        End If
    End Sub
End Class
