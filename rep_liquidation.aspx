<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_liquidation.aspx.vb" Inherits="srx.rep_liquidation" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">					
					<asp:ImageButton id="btnBackImg" runat="server" ImageUrl="images/backarrow.png" Tooltip="Back To Lists" CssClass="backImg w3-hover-opacity" UseSubmitBehavior="False"/>
					<b>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Liquidation Report" runat="server" ForeColor="Red"
						CssClass="w3-medium w3-bar-item w3-mobile"></asp:label></b>					
				</div>
				<!-- End Header -->
				...
				<p>
					<div class="w3-row">
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">Liquidation Date From:</div>
								<div class="w3-rest">
						...
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">Liquidation Date To:</div>
								<div class="w3-rest">
				...
				<p>
					<div class="w3-row w3-section">
						<div class="w3-quarter">
							...
							<asp:listbox id="lstDDL1" runat="server" SelectionMode="Multiple" CssClass="ddl">								
								<asp:ListItem Value="APPROVED">FOR LIQUIDATION</asp:ListItem>
								<asp:ListItem Value="LIQUIDATED">LIQUIDATED</asp:ListItem>								
							</asp:listbox>
						</div>
						<div class="w3-quarter">
							<div class="w3-col s6" style="WIDTH:100px">Budget Holder:</div>
							<asp:listbox id="lstDDL2" runat="server" SelectionMode="Multiple" CssClass="ddl"></asp:listbox>
						</div>	
						<div class="w3-quarter" style="display:none">
							<div class="w3-col s6" style="WIDTH:100px">Account Name:</div>
							<asp:listbox id="lstDDL3" runat="server" SelectionMode="Multiple" CssClass="ddl"></asp:listbox>
						</div>	
						<div class="w3-quarter" style="display:none">
							<div class="w3-col s6" style="WIDTH:100px">Item:</div>
							<asp:listbox id="lstDDL4" runat="server" SelectionMode="Multiple" CssClass="ddl"></asp:listbox>
						</div>											
					</div>
				</p>
				<hr>
