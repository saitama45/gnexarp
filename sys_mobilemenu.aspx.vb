...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        While objReader.Read
            ...
            If Trim(objReader("main_menu")) = lblPO.Text Then
                ...
                If Trim(objReader("link_page")) <> "" Then
                    ...
                    divPO.Style.Remove("pointer-events")
                    divPO.Style.Remove("opacity")
                    ...
                    tblPOModule.Rows.Add(tableRow)

                Else
                    divPO.Style("pointer-events") = "none"
                    divPO.Style("opacity") = "0.5"
                End If
            End If
            ...
            If Trim(objReader("main_menu")) = lblDR.Text Then
                If Trim(objReader("link_page")) <> "" Then
                    ...
                    tableRow.Cells.Add(tableCell)
                    tblDeliveryModule.Rows.Add(tableRow)

                    divDelivery.Style.Remove("pointer-events")
                    divDelivery.Style.Remove("opacity")
                Else
                    divDelivery.Style("pointer-events") = "none"
                    divDelivery.Style("opacity") = "0.5"
                End If
            End If
            ...
            If Trim(objReader("main_menu")) = lblMenu2.Text Then
                If Trim(objReader("link_page")) <> "" Then
                    ...
                    tableRow.Cells.Add(tableCell)
                    tblPayablesModule.Rows.Add(tableRow)

                    divPayables.Style.Remove("pointer-events")
                    divPayables.Style.Remove("opacity")
                Else
                    divPayables.Style("pointer-events") = "none"
                    divPayables.Style("opacity") = "0.5"
                End If
            End If
            ...
            If Trim(objReader("main_menu")) = lblReference.Text Then
                If Trim(objReader("link_page")) <> "" Then
                    ...
                    divReferences.Style.Remove("pointer-events")
                    divReferences.Style.Remove("opacity")
                Else
                    divReferences.Style("pointer-events") = "none"
                    divReferences.Style("opacity") = "0.5"
                End If
            End If
            ...
            If Trim(objReader("main_menu")) = lblMenu1.Text Then
                If Trim(objReader("link_page")) <> "" Then
                    ...
                    tableRow.Cells.Add(tableCell)
                    tblBudgetModule.Rows.Add(tableRow)

                    divBudget.Style.Remove("pointer-events")
                    divBudget.Style.Remove("opacity")
                Else
                    divBudget.Style("pointer-events") = "none"
                    divBudget.Style("opacity") = "0.5"
                End If
            End If
        ...
        If Session("Sys_AccessList").indexof("ref_clients_list".ToLower & "_access") > 0 Then
            divCustomers.Style.Remove("pointer-events")
            divCustomers.Style.Remove("opacity")
        Else
            divCustomers.Style("pointer-events") = "none"
            divCustomers.Style("opacity") = "0.5"
        End If

        If Session("Sys_AccessList").indexof("inv_payments_list".ToLower & "_access") > 0 Then
            divReceivables.Style.Remove("pointer-events")
            divReceivables.Style.Remove("opacity")
        Else
            divReceivables.Style("pointer-events") = "none"
            divReceivables.Style("opacity") = "0.5"
        End If

        If Session("Sys_AccessList").indexof("inv_projects_list".ToLower & "_access") > 0 Then
            divProjects.Style.Remove("pointer-events")
            divProjects.Style.Remove("opacity")
        Else
            divProjects.Style("pointer-events") = "none"
            divProjects.Style("opacity") = "0.5"
        End If
    End Sub
