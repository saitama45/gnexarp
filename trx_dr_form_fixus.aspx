<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form_fixus.aspx.vb" Inherits="srx.trx_dr_form_fixus" %>
...
<HTML>
	<HEAD>
		...
		<style>
            ...
            DIV.vendor_name { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 7em; TOP: 155px }
			DIV.vendor_address { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 15em; TOP: 209px }
           
			DIV.pr_code { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 40em; TOP: 90px; display:none }
            DIV.pr_date { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 37em; TOP: 137px }
			DIV.tin_no { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 46em; TOP: 180px }
			DIV.terms { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 37em; TOP: 207px }	
			
			DIV.net_sales { FONT-SIZE: 14px; POSITION: fixed; PADDING-LEFT: 45em; TOP: 700px }
			...
			.qty {
				width: 85px; /* Specify the width for the first column */
			}
			.uom {
