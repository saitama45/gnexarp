...
Public Class rep_checkdeposit_notif
...
#End Region
    ...
    Public strSubMenuName As String = "ref_checkdeposit_notif"
    Public strStoredProc As String = "rep_checkdeposit_notif"
    Public strSubMenuFullView As String = "rep_checkdeposit_notif_popup"
    ...
    Public strFileNameExcel As String = "ForChequeDepositsReport.xls"
    Public strFileNamePDF As String = "ForChequeDepositsReport.pdf"
