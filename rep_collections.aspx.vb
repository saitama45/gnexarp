...
#End Region
    ...
    Public strSubMenuName As String = "rep_collections"
    Public strStoredProc As String = "rep_collections"
    Public strSubMenuFullView As String = "rep_collections_popup"
    ...
    Public strFileNameExcel As String = "CollectionsReport.xls"
    Public strFileNamePDF As String = "CollectionsReport.pdf"
