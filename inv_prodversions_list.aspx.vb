...
Public Class inv_prodversions_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents cbxIsActive As System.Web.UI.WebControls.CheckBox
    Protected WithEvents lblVersion As System.Web.UI.WebControls.Label
    Protected WithEvents panelVersion As System.Web.UI.WebControls.Panel
...
#End Region
    ...
    Public strSubMenuName As String = "inv_prodversions_list"
    Public strStoredProc As String = "Inv_ProdVersions_List"

    'the default sortkey and key field
    'values must match with any of those DataGrid_ItemCreated.aSortKeys() items
    Public strDefaultSortKey As String = "prod_code"
    ...
    Private Sub btnAddRecord_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        Dim objCommand As New SqlCommand("Ref_Products_Get_Droplist", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        Dim objReader As SqlDataReader = objCommand.ExecuteReader
        ddlProduct.DataSource = objReader
    ...
    Private Sub ReadyEdit()
        ...
        lblVersion.Text = Trim(objReader("version"))
        txtDesc.Text = objReader("description")
        txtDesc.Enabled = True
        panelVersion.Visible = True

        If objReader("is_active") = "Yes" Then
            cbxIsActive.Checked = True
        Else
        ...
        Dim strProducts As String = objReader("prod_code")

        objReader.Close()

        objCommand = New SqlCommand("Ref_Products_Get_Droplist", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        ddlProduct.SelectedIndex = ddlProduct.Items.IndexOf(ddlProduct.Items.FindByValue(strProducts.ToString))
    ...
    Private Function SaveInput()
        ...
        Try
            ...
            'get the name of UOM
            objCommand = New SqlCommand("Ref_Products_Get", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@code", ddlProduct.SelectedValue)
            Dim objReader As SqlDataReader = objCommand.ExecuteReader
            objReader.Read()

            Dim strProdCode As String = objReader("code")
            objReader.Close()
            ...
            If cbxIsActive.Checked = True Then
                ...
                Sys_Class.SaveToAuditTrail(Session("username"), _
                                            ...
                                            strSubMenuName, _
                                            "Ref# " + lblID.Text + " ProdCode: " + strProdCode + " > Desc: " + txtDesc.Text + " > IsActive?: Yes", _
                                            objNewID.Value, _
                                            0)
            Else
                'save to audit trail 
                Sys_Class.SaveToAuditTrail(Session("username"), _
                                            txtFormAction.Text, _
                                            strSubMenuName, _
                                            "Ref# " + lblID.Text + " ProdCode: " + strProdCode + " > Desc: " + txtDesc.Text + " > IsActive?: No", _
                                            objNewID.Value, _
                                            0)
            End If
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_ProdVersions_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@prod_code", ddlProduct.SelectedValue)        
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            btnAddRecord.Text = "Add Product Version"
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "RawMats" Then

            Response.Redirect("inv_prodrawmats_list.aspx?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
