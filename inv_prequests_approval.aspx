<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_prequests_approval.aspx.vb" Inherits="srx.inv_prequests_approval" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;PR Approval</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 800px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='inv_prequests_approval'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							<P><LABEL><B>P.O.#</B></LABEL><BR>
								<asp:label id="lblPONum" runat="server" CssClass="w3-large"></asp:label>
							</P>
							<P><LABEL><B>P.O. Discount</B></LABEL><BR>
								<asp:label id="lblDiscount" runat="server" CssClass="w3-large"></asp:label>
							</P>
							<P><LABEL><B>P.O. Net Amount</B></LABEL><BR>
								<asp:label id="lblPONetAmount" runat="server" CssClass="w3-large"></asp:label>
								<asp:label id="lblSupplierCode" runat="server" CssClass="w3-large" Visible="False"></asp:label>
