<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_payments_list.aspx.vb" Inherits="srx.inv_payments_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Receivables</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">												
							<%response.write("<a class='w3-hover-blue' href='inv_payments_list.aspx'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>SO Date</B></LABEL><BR>
								<ew:calendarpopup tabIndex="1" id="calSODate" style="Z-INDEX: 0" runat="server" Width="53%"
							...
							<P><LABEL><B>Customer</B></LABEL><BR>
								<asp:dropdownlist tabIndex="2" id="ddlClient" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
							</P>	
							<P><LABEL><B>Note</B></LABEL><BR>
								<asp:textbox tabIndex="3" id="txtNote" runat="server" CssClass="w3-input w3-border" TextMode="MultiLine" Maxlength="1000"></asp:textbox>
							</P>																																
						</DIV>
							...
							<div class="w3-bar w3-margin-right w3-mobile w3-responsive">
								<p>    
									...
									<asp:button id="btnSearch" accessKey="S" runat="server" Text="Go" CssClass="w3-bar-item w3-btn w3-green w3-mobile" CausesValidation="False" OnClientClick="searchButtonClick()"></asp:button>																	
										...
										<%response.write("<a class='w3-btn w3-margin-right w3-blue w3-hover-light-blue w3-mobile w3-right' style='width:10%' href='inv_paid_list'>Batch Payment</a>")%>&nbsp;
