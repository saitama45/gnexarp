<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="inv_procurement_list.aspx.vb" Inherits="srx.inv_procurement_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Procurement Status</b></h5>
				</div>
				<!-- End Header -->
						...
						<DIV class="w3-section w3-medium">							
							...
							<div class="w3-row w3-container">
								<LABEL><B>Account Name</B></LABEL><BR>
									...
									<asp:label id="lblCustomerCode" runat="server" Visible="True"></asp:label>
							</div>
							<br>				
							<div class="w3-row">
				...
				<div class="w3-row-padding w3-margin-bottom">					
					...
					<div class="w3-third">
					  <div class="w3-container w3-gray w3-padding-16 w3-card-4">
						<div class="w3-left">
							<h4><b>CANCELLED</b></h4>
						</div>						
						<div class="w3-clear"></div>
						<div class="w3-center">
							<h4><asp:label id="lblCancelled" runat="server"></asp:label></h4>
						</div>
					  </div>
					</div>					
					<div class="w3-third">
				...
				<asp:panel id="panelGrid" style="Z-INDEX: 0;" runat="server" Visible="True">
					<div class="w3-rest w3-padding w3-mobile">
						...
						<div class="w3-cell-row">
							<div class="w3-bar w3-margin-right w3-mobile w3-responsive">
								<p>    
									...
									<asp:button id="btnDownload" runat="server" Text="Export PENDINGS" CssClass="w3-btn w3-bar-item w3-right w3-green w3-mobile"></asp:button>
						...
						<div style="display:none">
							<asp:datagrid id="dgList" runat="server" ShowFooter="True" CellPadding="3" Width="100%" Height="24px"
								BackColor="White" BorderWidth="1px" BorderColor="#999999" AllowSorting="True" GridLines="Vertical"
								BorderStyle="None">
								<FooterStyle ForeColor="White" BackColor="#708090"></FooterStyle>
								<SelectedItemStyle Font-Bold="True" ForeColor="Black" CssClass="w3-pale-blue" BackColor="Green"></SelectedItemStyle>
