<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form.aspx.vb" Inherits="srx.trx_dr_form" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.invoice_no { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 59em; TOP: 91px; width: 100%; }
			...
			DIV.vendor_contact { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 120px }
			DIV.vendor_contactno { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 140px }
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				<div class="image_header">
					<img src="./images/drform.jpg" alt="receivingform" class="img_background" >
