<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="inv_requisitions_list.aspx.vb" Inherits="srx.inv_requisitions_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Requisitions</b></h5>
				</div>
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0;" runat="server" Visible="False">				
					<DIV id="id01" class="w3-card-4" style="margin: auto; MAX-WIDTH: 600px">												
						...
						<DIV class="w3-section w3-medium">							
							<%response.write("<a class='w3-hover-blue' href='inv_requisitions_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							...
							<div class="w3-row">
								...
								<div class="w3-half w3-container">
									<LABEL><B>RF No.</B></LABEL><BR>
										<asp:textbox id="txtRFNo" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Type RF No." required></asp:textbox>									
								</div>								
							</div>
							<br>	
							<div class="w3-row">
								<div class="w3-half w3-container">
									<LABEL><B>SO# / ProjID</B></LABEL><BR>
										<asp:textbox id="txtSONo" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Search SO No." Visible="False" Autopostback="True"></asp:textbox>
								</div>
								<div class="w3-half w3-container">
									<LABEL><B>Location</B></LABEL><BR>
										<asp:textbox id="txtLocation" runat="server" CssClass="w3-input w3-white w3-border"></asp:textbox>
								</div>
							</div>
							<br>			
							<div class="w3-row">
								<div class="w3-half w3-container">
									<LABEL><B>Date Requested</B></LABEL><BR>
										<ew:calendarpopup id="calRequestedDate" style="Z-INDEX: 0" runat="server"
								...
								<div class="w3-half w3-container">									
									<b><asp:CheckBox id="chbNeededDate" runat="server" Text=" Date Needed" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;</b>
									<br>									
										<ew:calendarpopup id="calNeededDate" style="Z-INDEX: 0" runat="server" Visible="False"
											CellPadding="2px" ShowGoToToday="True" CalendarLocation="Bottom" AllowArbitraryText="False" DisableTextboxEntry="False"
											ImageUrl="images/calendar-icon-mac.jpg" ControlDisplay="TextBoxImage" onkeypress="return clickButton(event,'btnSave')">
											<WEEKDAYSTYLE BackColor="White" ForeColor="Black" Font-Names="Verdana,Helvetica,Tahoma,Arial"
												Font-Size="Medium"></WEEKDAYSTYLE>
							...
							<div class="w3-row">
								<div class="w3-half w3-container">
									<LABEL><B>Budget Holder</B></LABEL><BR>										
										<asp:dropdownlist id="ddlBudgetHolder" runat="server" CssClass="w3-tag w3-input w3-border w3-pale-blue w3-mobile myddl" required></asp:dropdownlist>
								</div>
								<div class="w3-half w3-container">
									<LABEL><B>Particulars</B></LABEL><BR>
										<asp:textbox id="txtParticulars" runat="server" CssClass="w3-input w3-border" TextMode="MultiLine" Maxlength="1000" required></asp:textbox>	
								</div>
							</div>																																																		
						</DIV>
						...
						<div class="w3-cell-row">
							<div class="w3-bar w3-margin-right w3-mobile w3-responsive">
								<p>    
									...
									<%response.write("<a class='w3-btn w3-blue w3-hover-light-blue w3-mobile w3-right' style='width:10%' href='rep_budgetrequests'>BR Report</a>")%>&nbsp;
		...
		<script>
			...
			$(document).ready(function() {
				...
				if (companyText == "SVT") {
					...
					$('#<%= Datagrid.ClientID %> tr td:nth-child(5)').hide();								
					$('#<%= Datagrid.ClientID %> tr td:nth-child(6)').hide();
					$('#<%= Datagrid.ClientID %> tr td:nth-child(7)').hide();
				}
			});
		</script>		
	</body>
