...
Public Class ref_warehouse_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents chbHO As System.Web.UI.WebControls.CheckBox
...
#End Region
    ...
    Public strSubMenuName As String = "ref_warehouse_list"
    Public strStoredProc As String = "ref_warehouse_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim strCompany As String = Trim(objReader("company"))
        ...
        lblName.Text = Trim(objReader("name"))
        ...
        lblCompany.Text = Trim(objReader("company"))
        ddlCompany.Visible = False
        lblCompany.Visible = True

        If Trim(objReader("isHO")) = True Then
            chbHO.Checked = True
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Warehouse_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@soh", lblSOH.Text)
        ...
        If chbHO.Checked = True Then
            objCommand.Parameters.Add("@isHO", True)
        Else
            objCommand.Parameters.Add("@isHO", False)
        End If
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Warehouse_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@status", ddlStatus.SelectedValue)
