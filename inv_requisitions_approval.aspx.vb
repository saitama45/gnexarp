...
Public Class inv_requisitions_approval
...
#End Region
    ...
    Public strSubMenuName As String = "inv_requisitions_approval"
    Public strStoredProc As String = "inv_requisitions_approval"
    Public strStoredProc2 As String = "inv_requisitionsdtl_list"
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_RequisitionsApproval_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            ElseIf txtFormAction.Text = "Disapprove" Then
                'save to audit trail 
                Sys_Class.SaveToAuditTrail(Session("username"), _
                                            txtFormAction.Text, _
                                            strSubMenuName, _
    ...
    Private Function ValidateInput()
        ...
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@requested_date", DateTime.UtcNow.AddHours(8).ToShortDateString)
        objCommand.Parameters.Add("@id", lblID.Text)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Approve" Then
            ...
            lblAmount.Text = Trim(objReader("total_amount"))
        ...
        ElseIf e.CommandName = "Disapprove" Then
