...
Public Class ref_expensetype_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_expensetype_list"
    Public strStoredProc As String = "ref_expensetype_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_ExpenseType_Get", objConnection)
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_ExpenseType_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_ExpenseType_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@name", txtName.Text)
