...
#End Region
    ...
    Public strSubMenuName As String = "rep_liquidation"
    Public strStoredProc As String = "rep_liquidation"
    Public strSubMenuFullView As String = "rep_liquidation_popup"
    ...
    Public strFileNameExcel As String = "LiquidationReport.xls"
    Public strFileNamePDF As String = "LiquidationReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim objCommand As New SqlCommand("Ref_Payee_Get_droplist", objConnection)
            ...
            objCommand = New SqlCommand("Ref_Payee_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@Session_username", Session("username"))
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        objCommand.Parameters.Add("@budget_holder", DDL2Value)       
