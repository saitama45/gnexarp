...
Public Class ref_industry_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents ddlSRPCode As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Public strSubMenuName As String = "ref_industry_list"
    Public strStoredProc As String = "ref_industry_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_Industry_GetID", objConnection)
        ...
        Dim strSRPCode = Trim(objReader("srp_code"))

        lblID.Text = objReader("id")

        txtName.Text = Trim(objReader("name"))

        ddlSRPCode.SelectedValue = Trim(objReader("srp_code"))
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Industry_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        objCommand.Parameters.Add("@srp_code", ddlSRPCode.SelectedValue)
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Industry_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@name", txtName.Text)
