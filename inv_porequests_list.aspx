<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="inv_porequests_list.aspx.vb" Inherits="srx.inv_porequests_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Purchase Requests</b></h5>
				</div>
				<!-- End Header -->
				<!-- #include file ="html\AlertPanel.html" -->
				<!-- Input Form -->
				<asp:panel id="panelApprove" style="Z-INDEX: 0;" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto; MAX-WIDTH: 600px">												
						<HEADER class="w3-light-grey w3-display-container w3-responsive" style="display:none">								
							<H2 class="w3-center">
								<asp:label id="lblModeApprove" runat="server" Visible="true"></asp:label>
								<asp:textbox id="txtFormActionApprove" runat="server" Visible="true"></asp:textbox>
							</H2>
						</HEADER>
						<DIV class="w3-section w3-medium">							
							<%response.write("<a class='w3-hover-blue' href='inv_porequests_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							<P style="display:none"><LABEL><B></B></LABEL><BR>
								<asp:label id="lblIDApprove" runat="server" Visible="false"></asp:label>
							</P>
							<div class="w3-row w3-container">								
								<LABEL><B>Account Name</B></LABEL><BR>
									<asp:label id="lblCustomerApprove" runat="server"></asp:label>
									<asp:label id="lblCustomerCodeApprove" runat="server" Visible="False"></asp:label>															
							</div>
							<br>
							<div class="w3-row">
							...
							<div class="w3-row">
								<div class="w3-third w3-container">
									<LABEL><B>PR No.</B></LABEL><BR>
										<asp:label id="lblPRNo" runat="server"></asp:label>
								</div>
								<div class="w3-third w3-container">									
									<LABEL><B>PR Date</B></LABEL><BR>
						...
						<DIV class="w3-row w3-container w3-padding">
							<div class="w3-half w3-container">
								<asp:button id="btnSaveApprove" OnClientClick="return confirm('Are you sure you want to approve?');" CssClass="w3-btn w3-green w3-block w3-large" runat="server" Text="Save"></asp:button>
							</div>    
							<div class="w3-half w3-container">
								<asp:button id="btnCancelApprove" OnClientClick="return confirm('Are you sure you want to cancel?');" CssClass="w3-btn w3-red w3-block w3-large" runat="server" Text="Cancel"></asp:button>
							</div>
						</DIV>
