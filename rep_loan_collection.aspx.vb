...
Public Class rep_loan_collection
...
#End Region
    ...
    Public strSubMenuName As String = "rep_loan_collection"
    Public strStoredProc As String = "rep_loan_collection"
    Public strSubMenuFullView As String = "rep_loan_collection_popup"
    ...
    Public strFileNameExcel As String = "LoanCollectionsReport.xls"
    Public strFileNamePDF As String = "LoanCollectionsReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then            
            ...
            lstItems.DataBind()
            lstItems.SelectedValue = Date.UtcNow.AddHours(8).Year
            lstWarehouse.SelectedValue = Date.UtcNow.AddHours(8).Month
            objReader.Close()
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        objCommand.Parameters.Add("@month", lstWarehouse.SelectedValue)
        objCommand.Parameters.Add("@year", lstItems.SelectedValue)
