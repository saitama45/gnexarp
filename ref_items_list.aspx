<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_items_list.aspx.vb" Inherits="ems.ref_items_list" %>
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='ref_items_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>Cost</B></LABEL><BR>
								<asp:textbox tabIndex="12" id="txtCost" runat="server" Width="100%" Placeholder="0" CssClass="amount" required onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
							</P>
							<P><LABEL><B>Landed Cost</B></LABEL><BR>
								<asp:textbox tabIndex="13" id="txtLandedCost" runat="server" Width="100%" Placeholder="0" CssClass="amount" required onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
							</P>													
							<P><LABEL><B>SRP <asp:label id="lblSRP" runat="server"></asp:label></B></LABEL><BR>
							...
							<P><LABEL><B>SRP2 <asp:label id="lblSRP2" runat="server"></asp:label></B></LABEL><BR>
							...
							<P><LABEL><B>SRP3 <asp:label id="lblSRP3" runat="server"></asp:label></B></LABEL><BR>
							...
							<P><LABEL><B>SRP4 <asp:label id="lblSRP4" runat="server"></asp:label></B></LABEL><BR>
							...
							<P><LABEL><B>SRP5 <asp:label id="lblSRP5" runat="server"></asp:label></B></LABEL><BR>
							...
							<div style="display:none;">								
								<P><LABEL><B>SRP6 (<asp:label id="lblSRP6" runat="server"></asp:label>)</B></LABEL><BR>
								...
								<P><LABEL><B>SRP7 (<asp:label id="lblSRP7" runat="server"></asp:label>)</B></LABEL><BR>
		...
		<script>
			...
			$(document).ready(function() {
				...
				if (companyText === "COSMOMED") {					
					 ...
					 // Change the text of the <td> containing "Item Code" to "Part Number"
					$('td:contains("Item Code")').text("Part Number").css('font-weight', 'bold');
				}
			});
