...
Public Class rep_inventory_audit
...
#End Region
    ...
    Public strSubMenuName As String = "rep_inventory_audit"
    Public strStoredProc As String = "rep_inventory_audit"
