...
Public Class inv_projects_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btnProjectStatus As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Public strSubMenuName As String = "inv_projects_list"
    Public strStoredProc As String = "inv_projects_list"

    'the default sortkey and key field
    'values must match with any of those DataGrid_ItemCreated.aSortKeys() items
    Public strDefaultSortKey As String = "so_no"
    Public strKeyField As String = "so_no"
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_projecttasks_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)

        End If

    End Sub

    Private Sub btnProjectStatus_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProjectStatus.Click
        SetEndPopup("rep_projectstatus")
    End Sub
End Class
