...
Public Class ref_loanterms_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_loanterms_list"
    Public strStoredProc As String = "ref_loanterms_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_LoanTerms_GetID", objConnection)
        ...
        txtName.Text = Trim(objReader("no_months"))
        txtInterest.Text = Trim(objReader("interest"))
    ...
    Private Sub ReadyDelete()
        ...
        lblID.Text = objReader("id")
        txtName.Text = objReader("no_months")
        txtInterest.Text = objReader("interest")
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_LoanTerms_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@company", ddlCompany.SelectedValue)
        objCommand.Parameters.Add("@no_months", txtName.Text)
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_LoanTerms_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@company", ddlCompany.SelectedValue)
        objCommand.Parameters.Add("@no_months", txtName.Text)
        objCommand.Parameters.Add("@interest", txtInterest.Text)
