<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_issuance_approval.aspx.vb" Inherits="srx.inv_issuance_approval" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;SO Approval</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 800px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='inv_issuance_approval'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							<P style="display:none;"><LABEL><B>DR#</B></LABEL><BR>
								<asp:label id="lblDRNum" runat="server" CssClass="w3-medium"></asp:label>
								<asp:label id="lblStatus" runat="server" CssClass="w3-medium"></asp:label>
							...
							<P><LABEL><B>SI#</B></LABEL><BR>
								<asp:label id="lblSINum" runat="server" CssClass="w3-medium"></asp:label>
							</P>
							<div class="w3-row">
								<div class="w3-half">
								...
								<div class="w3-half">
									<asp:CheckBox tabIndex="3" id="chbNoExpiryDate" runat="server" Text=" Is Delivered?" Checked="True" AutoPostBack="True"></asp:CheckBox>&nbsp;
									<P><asp:label runat="server" id="lblDateDelivered"><B>Date Delivered</B></asp:label><BR>
							...
							<P>
								...
								<div class="w3-responsive">
									<TABLE id="tblGroupList" class="w3-table-all w3-hoverable" cellSpacing="0" cellPadding="2"
										...
										<tr>
											<th>
												<asp:datagrid id="DataGrid2" runat="server" ShowFooter="False" CellPadding="3" Width="100%" Height="24px"
