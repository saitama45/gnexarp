<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_subcategories.aspx.vb" Inherits="srx.rep_subcategories" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">
					<h5 class="w3-left"><b>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="SubCategories Inventory Report" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row w3-section">
						<div class="w3-quarter">
							<div class="w3-col s6" style="WIDTH:100px">SubCategories:</div>
