<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_costofinventories.aspx.vb" Inherits="srx.rep_costofinventories" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Cost of Inventory" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row w3-section">
						<div class="w3-third">
							<div class="w3-col s6" style="WIDTH:100px">Item Desc:</div>
