...
Public Class ref_safetylevel_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_safetylevel_list"
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("ref_safetylevelitems_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
