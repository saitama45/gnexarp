...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents chbTerms As System.Web.UI.WebControls.CheckBox
...
#End Region
    ...
    Public strSubMenuName As String = "inv_dr_list"
    Public strStoredProc As String = "inv_dr_list"
    Public strStoredProcPageCount As String = "Inv_DRPageCount_Get"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        If Not Page.IsPostBack Then
            ...
            'btnAddRecord.Text = "Add Issuance"
    ...
    Private Sub btnAddRecord_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        ddlCompany.SelectedIndex = Nothing
        objReader.Close()
    ...
    Private Sub ReadyEdit()
        ...
        'calDRDate.Enabled = bolChangeable
    ...
    Private Sub ClearInputs()
        ...
        'calDRDate.SelectedDate = Date.UtcNow.AddHours(8)
        'calDRDate.Enabled = True
    ...
    Private Function SaveInput()
        ...
        If chbTerms.Checked = True Then
            objCommand.Parameters.Add("@terms", txtTerms.Text)
        Else
            objCommand.Parameters.Add("@terms", "")
        End If
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_issueditems_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_issueditems_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
    ...
    Private Sub chbTerms_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chbTerms.CheckedChanged
        If chbTerms.Checked = True Then
