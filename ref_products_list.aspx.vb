...
Public Class ref_products_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_products_list"
    Public strStoredProc As String = "Ref_Products_List"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        If Not Page.IsPostBack Then
            ...
            hlViewFullTrail.NavigateUrl = "trx_fullhistory.aspx?sys_table=" & strSubMenuName & "&mode=2&ID=0"
        End If
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_Products_Get", objConnection)
        ...
        txtStock.Text = Trim(objReader("stock"))
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Products_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Products_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@name", txtName.Text)
        objCommand.Parameters.Add("@stock", txtStock.Text)
        ...
        Try
            ...
            Sys_Class.SaveToAuditTrail(Session("username"), _
                                        ...
                                        strSubMenuName, _
                                        "Ref#: " + lblID.Text + " > Product: " + txtName.Text + " > StockOnHand: " + txtStock.Text, _
                                        objNewID.Value, _
                                        "0")
