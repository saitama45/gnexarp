<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_requisitions_approval.aspx.vb" Inherits="srx.inv_requisitions_approval" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
	...
	<!-- #include file ="html\BodyColor.html" -->
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Requisitions Approval</b></h5>
				</div>
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 800px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='inv_requisitions_approval'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>Amount</B></LABEL><BR>
								<asp:label id="lblAmount" runat="server" CssClass="w3-large"></asp:label>
								...
								<th>
									<asp:datagrid id="DataGrid" runat="server" ShowFooter="False" CellPadding="3" Width="100%" Height="24px"
										...
										<Columns>											
											...
											<asp:ButtonColumn Text="Disapprove" CommandName="Disapprove"></asp:ButtonColumn>
										</Columns>
										<PagerStyle HorizontalAlign="Center" ForeColor="Black" BackColor="#999999" Mode="NumericPages"></PagerStyle>
									</asp:datagrid>
								</th>
		...
		<script>
			...
			$(document).ready(function() {
				...
				var cancelLinks = $("td a[href*='__doPostBack']:contains('Disapprove')");
			...
			$(document).ready(function() {
				...
				if (companyText == "SVT") {
					...
					$('#<%= Datagrid.ClientID %> tr td:nth-child(8)').hide();
				}
			});
		</script>
	</body>
