<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_cv_print_sfs.aspx.vb" Inherits="srx.trx_cv_print_sfs" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.form_title { POSITION: absolute;PADDING-LEFT: 60em; TOP: 5px; width: 120%; }
			...
			DIV.cash_no { FONT-SIZE: 14px; POSITION: absolute;PADDING-LEFT: 43em; TOP: 70px; width: 100%; }
			DIV.check_no { FONT-SIZE: 14px; POSITION: absolute;PADDING-LEFT: 43em; TOP: 90px; width: 100%; }		
			DIV.check_date { FONT-SIZE: 14px; POSITION: absolute;PADDING-LEFT: 43em; TOP: 110px; width: 100%; }		
			DIV.check_amount { FONT-SIZE: 14px; POSITION: absolute;PADDING-LEFT: 43em; TOP: 130px; width: 100%; }		
			...
			DIV.received_by { FONT-SIZE: 11px; display: flex; flex-wrap: wrap; row-gap: 10px; column-gap: 1em; }									
