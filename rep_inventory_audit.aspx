<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_inventory_audit.aspx.vb" Inherits="srx.rep_inventory_audit" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-project-diagram"></i>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Inventory Audit Trail Report" runat="server" ForeColor="Red"
