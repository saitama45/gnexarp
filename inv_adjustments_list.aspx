<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_adjustments_list.aspx.vb" Inherits="srx.inv_adjustments_list" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			.myDataGrid tr th:nth-child(1),
			.myDataGrid tr td:nth-child(1) {
				display: none;
			}
		</style>
	</HEAD>
	<!-- #include file ="html\BodyColor.html" -->
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Stock Adjustments</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 800px">
						...
						<DIV class="w3-section w3-medium">
							<%response.write("<a class='w3-hover-blue' href='inv_adjustments_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							...
							<div class="w3-row">
								<div class="w3-half">									
									<div class="w3-container">
										<LABEL><B>Entry Type</B></LABEL><BR>								
										<asp:dropdownlist tabIndex="3" id="ddlEntryType" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl">
											<asp:ListItem Value="BegInv">BegInv</asp:ListItem>
											<asp:ListItem Value="ADJUSTMENT" Selected="True">ADJUSTMENT</asp:ListItem>									
										</asp:dropdownlist>
									</div>
								</div>
								<div class="w3-half">
									<div class="w3-container w3-margin-left">
										...
										<ew:calendarpopup tabIndex="2" id="calDate" style="Z-INDEX: 0" runat="server" Width="53%"
							...
							<br>																										
							<P style="display:none"><LABEL><B>Barcode</B></LABEL><BR>
								<asp:textbox id="txtBarcode" runat="server" Placeholder="Scan barcode" CssClass="w3-input" AutoPostBack="True"></asp:textbox>
							</P>
							<div class="w3-row">
								<div class="w3-half">
									<div class="w3-container">
										<LABEL><B>Warehouse</B></LABEL><BR>
										<asp:dropdownlist id="ddlWarehouse" tabIndex="1" runat="server" CssClass="w3-tag w3-input w3-btn w3-bar-item w3-border w3-pale-blue w3-mobile myddl" AutoPostback="True"></asp:dropdownlist>
									</div>
								...
								<div class="w3-half">
									...
									<div class="w3-container w3-margin-left">										
										...
										<asp:dropdownlist tabIndex="2" id="ddlItem" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl" AutoPostBack="True"></asp:dropdownlist>
										<br>
										<asp:CheckBox id="chbItemNotFound" runat="server" Text=" New Inventory Item " Checked="False" Visible="False" AutoPostBack="True"></asp:CheckBox>&nbsp;
																				
										<asp:dropdownlist id="ddlSKUCode" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl" Visible="False"></asp:dropdownlist>
										
										<asp:textbox id="txtSerial" runat="server" CssClass="w3-input" Placeholder="Lot/Serial (Leave blank if none) " Visible="False"></asp:textbox>										
										<asp:CheckBox id="chbNoExpiryDate" runat="server" Text=" w/o Expiry Date" Checked="False" AutoPostBack="True" Visible="False"></asp:CheckBox>&nbsp;
										<br>										
										<ew:calendarpopup id="calExpiryDate" Text="Expiry Date" style="Z-INDEX: 0" runat="server" Width="53%"
											Height="30px" ShowGoToToday="True" CalendarLocation="Bottom" AllowArbitraryText="False" DisableTextboxEntry="False"
											ImageUrl="images/calendar-icon-mac.jpg" ControlDisplay="TextBoxImage" Visible="False">
											<WeekdayStyle Font-Size="Medium" Font-Names="Verdana,Helvetica,Tahoma,Arial" ForeColor="Black"
												BackColor="White"></WeekdayStyle>
											<MonthHeaderStyle Font-Size="Medium" Font-Names="Verdana,Helvetica,Tahoma,Arial" ForeColor="Black"
												BackColor="#8080FF"></MonthHeaderStyle>
							...
							<div class="w3-row">
								<div class="w3-third">
									<div class="w3-container">
										...
										<asp:label id="lblCurrentSOH" CssClass="w3-text-red w3-large w3-white w3-input" runat="server"></asp:label>
									</div>					
								</div>
								<div class="w3-third">
									<div class="w3-container">
										<LABEL><B>Enter Actual Count</B></LABEL><BR>
										<asp:textbox tabIndex="4" id="txtSOH" runat="server" CssClass="w3-input w3-border w3-large" Placeholder="0.00" required AutoPostBack="True" Visible="False"></asp:textbox>
									</div>							
								</div>
								<div class="w3-third">
									<div class="w3-container">
										<LABEL><B>Qty for adjustment</B></LABEL><BR>
										<asp:label id="lblVariance" CssClass="w3-text-red w3-large w3-white w3-input" runat="server"></asp:label>
									</div>							
								</div>
							</div>							
							<br>							
							<div class="w3-row">
								<div class="w3-container">
									...
									<asp:textbox tabIndex="5" id="txtNote" runat="server" CssClass="w3-input w3-border" TextMode="MultiLine" Maxlength="1000"></asp:textbox>
								</div>
							</div>																																													
						</DIV>
		...
		<script>        
			...
			$('#txtSOH').on('input', function(event) {
