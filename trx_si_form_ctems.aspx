<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_si_form_ctems.aspx.vb" Inherits="srx.trx_si_form_ctems" %>
	...
	<HEAD>
		...
		<style>
			BODY { 
					FONT-SIZE: 11px; 
					FONT-FAMILY: Verdana;
					/* background-image: url('./images/siform_fixus.jpg');            
                	background-repeat: no-repeat; */
				}	
			DIV.form_title { POSITION: fixed;PADDING-LEFT: 35em; TOP: 5px }		
			DIV.company_logo { POSITION: fixed;PADDING-LEFT: 6em; TOP: 1px; }
			DIV.printed_on { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 3em; TOP: 1180px; display:none }

            DIV.vendor_name { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 8em; TOP: 107px }
			DIV.vendor_address { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 6em; TOP: 126px; Width: 78%; }
            DIV.tin_no { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 7em; TOP: 164px }

            DIV.invoice_no { FONT-SIZE: 26px; color:red; POSITION: fixed; PADDING-LEFT: 30em; TOP: 80px; display:none }
			DIV.so_no { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 40em; TOP: 90px; display:none }
			DIV.pr_code { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 40em; TOP: 90px; display:none }
			
            DIV.pr_date { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 49em; TOP: 95px }
            DIV.terms { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 49em; TOP: 132px }
			DIV.po_no { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 49em; TOP: 150px }

			DIV.note { FONT-SIZE: 13px; POSITION: fixed; PADDING-LEFT: 16em; TOP: 180px; display:none }                        				
			
			.created_by { FONT-SIZE: 13px; PADDING-LEFT: 3em; display:none }	
			DIV.createdby_esign { PADDING-LEFT: 3em; display: none; }		
			.approved_by { FONT-SIZE: 13px; PADDING-LEFT: 45em; display:none }
            ...
            .label_prepared_by { FONT-SIZE: 12px; POSITION: fixed; LEFT: 210px; top: 930px;}
            .label_approved_by { FONT-SIZE: 12px; POSITION: fixed; LEFT: 330px; top: 930px;}
            .label_delivered_by { FONT-SIZE: 12px; POSITION: fixed; LEFT: 450px; top: 930px;}

			.created_by { FONT-SIZE: 12px; POSITION: fixed; LEFT: 180px; top: 950px;}
			...
			.qty {
				width: 70px; /* Specify the width for the first column */
			}
			.uom {
				width: 60px; /* Specify the width for the second column */
			}
			.item {
				width: 400px; /* Specify the width for the third column */
			}

			.cost {
				width: 100px; /* Specify the width for the third column */
			}		
	...
	<body>		
		...
		<div class="page">                                
			...
			<!-- <div class="datagrid"> -->
				...
				<asp:label id="lblNetCost" runat="server" CssClass="netcost"></asp:label>																							
				...
				<div class="container">
					...
					<div class="vat2">										
						<asp:label id="lblVAT2" runat="server" CssClass="vat2"></asp:label>
					</div>	
					<div class="vat_sales2">										
						<asp:label id="lblVatableSales2" runat="server" CssClass="vat_sales2"></asp:label>
					</div>
					...
					<div class="vat3">										
						<asp:label id="lblVAT3" runat="server" CssClass="vat3"></asp:label>
					</div>	
					<div class="vat_sales3">										
						<asp:label id="lblVatableSales3" runat="server" CssClass="vat_sales3"></asp:label>
					</div>
				</div>									

				<label class="label_prepared_by">Prepared By:</label>
				<label class="label_approved_by">Approved By:</label>
				<label class="label_delivered_by">Delivered By:</label>
