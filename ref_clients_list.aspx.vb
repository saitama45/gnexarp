...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblPanel1 As System.Web.UI.WebControls.Label
    Protected WithEvents panel1 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel1 As System.Web.UI.WebControls.Table
    Protected WithEvents lblPanel2 As System.Web.UI.WebControls.Label
    Protected WithEvents panel2 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel2 As System.Web.UI.WebControls.Table
    Protected WithEvents lblPanel3 As System.Web.UI.WebControls.Label
    Protected WithEvents panel3 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel3 As System.Web.UI.WebControls.Table
    Protected WithEvents lblPanel4 As System.Web.UI.WebControls.Label
    Protected WithEvents panel4 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel4 As System.Web.UI.WebControls.Table
    Protected WithEvents lblPanel5 As System.Web.UI.WebControls.Label
    Protected WithEvents panel5 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel5 As System.Web.UI.WebControls.Table
    Protected WithEvents lblPanel6 As System.Web.UI.WebControls.Label
    Protected WithEvents panel6 As System.Web.UI.WebControls.Panel
    Protected WithEvents tblPanel6 As System.Web.UI.WebControls.Table
...
#End Region
    ...
    Public strSubMenuName As String = "ref_clients_list"
    Public strStoredProc As String = "Ref_Clients_List"
    Public strStoredProcPageCount As String = "Inv_ClientsPageCount_Get"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        txtBranch.Text = objReader("name")
        txtTin.Text = objReader("tin_no")
        ...
        txtDeliveryAddress.Text = objReader("delivery_address")
        calClientSince.SelectedDate = objReader("client_since")
        ddlPricing.SelectedValue = Trim(objReader("pricing"))
        txtDiscount.Text = objReader("discount")

        calClientSince.VisibleDate = DateTime.UtcNow.AddHours(8)
    ...
    Private Sub ReadyDelete()
        ...
        txtClientCode.Text = objReader("client_code")
        txtBranch.Text = objReader("branch")
        txtTin.Text = objReader("tin_no")
        txtContact.Text = objReader("contact")
        txtContactNo.Text = objReader("contact_no")
        txtEmail.Text = objReader("email")
        ...
        ddlCGroup.SelectedIndex = ddlCGroup.Items.IndexOf(ddlCGroup.Items.FindByValue(strCustomerGroup.ToString))
        ddlCompany.SelectedIndex = ddlCompany.Items.IndexOf(ddlCompany.Items.FindByValue(strCity.ToString))
        ddlCity.SelectedIndex = ddlCity.Items.IndexOf(ddlCity.Items.FindByValue(strCity.ToString))
        ddlIndustry.SelectedIndex = ddlIndustry.Items.IndexOf(ddlIndustry.Items.FindByValue(strIndustry.ToString))
    ...
    Private Sub ClearInputs()
        ...
        ddlCity.DataTextField = "name"
        ddlCity.DataBind()
        'ddlRawMats.Items.Insert(0, "Select Items")
        ...
        txtTerms.Text = 0
        calClientSince.SelectedDate = DateTime.UtcNow.AddHours(8)
        ddlPricing.SelectedValue = "SRP"
        txtDiscount.Text = 0
    ...
    Private Function SaveInput()
        ...
        Try
            ...
            Sys_Class.SaveToAuditTrail(Session("username"), _
                                        ...
                                        strSubMenuName, _
                                        "Ref#: " + lblID.Text + " Status: " + ddlStatus.SelectedValue + " > Comapny: " + ddlCompany.SelectedValue + " > ClientName: " + txtName.Text + " > ClientCode: " + txtClientCode.Text + " > Branch: " + txtBranch.Text + " > Tin#: " + txtTin.Text + " > Contact: " + txtContact.Text + " > Contact#: " + txtContactNo.Text + " > Email: " + txtEmail.Text + " > Address: " + txtAddress.Text + " > DeliveryAddress: " + txtDeliveryAddress.Text + " > City: " + ddlCity.SelectedValue + " > Industry: " + ddlIndustry.SelectedValue + " > Terms:  " + txtTerms.Text + " > ClientSince: " + calClientSince.SelectedDate + " > Pricing: " + ddlPricing.SelectedValue, _
                                        objNewID.Value, _
                                        "0")
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("ref_clients_dtl?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
    ...
    Protected Sub UploadSO(ByVal sender As Object, ByVal e As EventArgs)
        Dim csvPath As String = Server.MapPath("~/Uploads/") + "uploadedCustomers.txt"
        ...
        If (Not FileUploadSO.PostedFile Is Nothing) AndAlso (FileUploadSO.PostedFile.ContentLength > 0) Then
            ...
            Try
                ...
                Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))
                Dim objCommand As New SqlCommand("upl_ImportCustomersCSV", objConnection)
                objCommand.CommandType = CommandType.StoredProcedure
                ...
                Else
                    ...
                    objCommand = New SqlCommand("Ref_CustomerUpload_Validate2", objConnection)
                    objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function ValidateUpload()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_CustomerUpload_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function SaveUpload()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_CustomerUpload_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
