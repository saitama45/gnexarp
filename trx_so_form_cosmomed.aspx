<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_so_form_cosmomed.aspx.vb" Inherits="srx.trx_so_form_cosmomed" %>
	...
	<body>				
		...
		<div class="header">
			<div class="image_header">					
				...
				<div>
					<label class="form_title">SALES ORDER</label>
				</div>	
			...
			<div class="pr_code">
				<LABEL class="header_class"><B>SO Number:</B></LABEL>
				<asp:label id="lblInvoiceNo" runat="server"></asp:label>
			</div>						
			<div class="pr_date">
				<LABEL class="header_class">SO Date:</LABEL>
