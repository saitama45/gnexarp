<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_requisitionsdtl_list.aspx.vb" Inherits="srx.inv_requisitionsdtl_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main">
				...
				<div style="MARGIN-TOP: 40px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Requisition Items</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4 myForm">
						...
						<DIV class="w3-medium" id="mydivheader">
							...
							<div class="w3-container">
								<LABEL><B>Qty</B></LABEL>
								<asp:textbox id="txtQty" runat="server" CssClass="w3-input" Placeholder="Type your Qty here...">0</asp:textbox>
							</div>
							<br>
							<div class="w3-container">
								<LABEL><B>Cost</B></LABEL>
								<asp:textbox id="txtCost" runat="server" CssClass="w3-input" Placeholder="Type your Cost here...">0</asp:textbox>
							</div>																				
						</div>	
					...
					<div class="w3-row">
						<div class="w3-third">
							<div class="w3-container w3-blue">	
								...
								<p>
									Location:&nbsp;		
									<asp:textbox id="txtLocation" runat="server" CssClass="w3-input w3-white w3-border" Autopostback="True"></asp:textbox>
								</p>
								<p>
									Date Requested:&nbsp;									
									<ew:calendarpopup id="calRequestedDate" style="Z-INDEX: 0" runat="server" CellPadding="2px" ShowGoToToday="True" 
								...
								<p>
									<asp:CheckBox id="chbNeededDate" runat="server" Text=" Date Needed" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;
									<br>																	
									<ew:calendarpopup id="calNeededDate" style="Z-INDEX: 0" runat="server" CellPadding="2px" ShowGoToToday="True" 
									CalendarLocation="Bottom" AllowArbitraryText="False" DisableTextboxEntry="False" ImageUrl="images/calendar-icon-mac.jpg" 
									ControlDisplay="TextBoxImage" Autopostback="True">
										<WEEKDAYSTYLE BackColor="White" ForeColor="Black" Font-Names="Verdana,Helvetica,Tahoma,Arial"
											Font-Size="Medium"></WEEKDAYSTYLE>
								...
								<p>
									Budget Holder:&nbsp;									
									<asp:dropdownlist id="ddlBudgetHolder" runat="server" CssClass="w3-tag w3-input w3-border w3-pale-blue w3-mobile myddl" AutoPostback="True"></asp:dropdownlist>
								</p>						
								<p>
									Particulars:&nbsp;
									<asp:textbox id="txtParticulars" runat="server" CssClass="w3-input w3-border w3-white" TextMode="MultiLine" Maxlength="1000" Enabled="True" Autopostback="True"></asp:textbox>									
								</p>																																										
							</div>							
						</div>						
						<div class="w3-rest w3-padding w3-mobile">
							...
							<p>
								...
								<asp:ImageButton id="btnPrintImg" Visible="True" runat="server" ImageUrl="images/printbtn.png" Tooltip="Print PR" CssClass="btnImg w3-bar-item w3-hover-opacity w3-right" />
