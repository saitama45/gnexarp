<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_receiving_approval.aspx.vb" Inherits="srx.inv_receiving_approval" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Receiving Approval</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 800px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='inv_receiving_approval.aspx'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							<div class="w3-row">
								<div class="w3-half">
									<P><LABEL><B>P.O. / REF #</B></LABEL><BR>
										<asp:label id="lblPONum" runat="server" CssClass="w3-large"></asp:label>
									</P>
									<P><LABEL><B>Supplier</B></LABEL><BR>
										<asp:label id="lblSupplier" runat="server" CssClass="w3-large"></asp:label>
									</P>
									<div style="display:none">
										<P><LABEL><B>Discount</B></LABEL><BR>
											<asp:label id="lblDiscount" runat="server" CssClass="w3-large"></asp:label>
										</P>
									</div>									
								</div>
								<div class="w3-half">
									<div style="display:none">
										<P><LABEL><B>P.O. Amount</B></LABEL><BR>
											<asp:label id="lblNetPOAmount" runat="server" CssClass="w3-large"></asp:label>								
										</P>
										<P><LABEL><B>Payable Amount</B></LABEL><BR>
											<asp:label id="lblNetPayable" runat="server" CssClass="w3-large"></asp:label>
