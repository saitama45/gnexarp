...
Public Class rep_product_sales
...
#End Region
    ...
    Public strSubMenuName As String = "rep_product_sales"
    Public strStoredProc As String = "rep_product_sales"
    Public strSubMenuFullView As String = "rep_product_sales_popup"
    ...
    Public strFileNameExcel As String = "ProductSalesReport.xls"
    Public strFileNamePDF As String = "ProductSalesReport.pdf"
