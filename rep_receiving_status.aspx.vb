...
Public Class rep_receiving_status
...
#End Region
    ...
    Public strSubMenuName As String = "rep_receiving_status"
    Public strStoredProc As String = "rep_receiving_status"
    Public strSubMenuFullView As String = "rep_receiving_status_popup.aspx"
    ...
    Public strFileNameExcel As String = "ReceivingStatusReport.xls"
    Public strFileNamePDF As String = "ReceivingStatusReport.pdf"
