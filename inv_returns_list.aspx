<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_returns_list.aspx.vb" Inherits="srx.inv_returns_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Stock Return</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						...
						<DIV class="w3-section w3-medium">
							<%response.write("<a class='w3-hover-blue' href='inv_returns_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							...
							<div class="w3-row">
								<div class="w3-half">
									<div class="w3-container">
										<LABEL><B>Source Warehouse</B></LABEL><BR>
								...
								<div class="w3-half">
									<div class="w3-container">
										...
										<ew:calendarpopup tabIndex="1" id="calDate" style="Z-INDEX: 0" runat="server" Width="53%"
							...
							<div class="w3-row">
								...
								<div class="w3-half">
									<div class="w3-container">
										...
										<asp:textbox tabIndex="3" id="txtAddress" runat="server" CssClass="w3-input w3-border" TextMode="MultiLine" Maxlength="1000"></asp:textbox>
									</div>
								</div>
							</div>																																										
							<div class="w3-container">
								<LABEL><B>Note</B></LABEL><BR>
								<asp:textbox tabIndex="4" id="txtNote" runat="server" CssClass="w3-input w3-border" TextMode="MultiLine" Maxlength="1000"></asp:textbox>
							</div>																																
						</DIV>
