...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load        
        ...
        If Not Page.IsPostBack Then
            ...
            lblCategoryName.Text = Trim(objReader("name"))

            objReader.Close()

            objCommand = New SqlCommand("Web_ItemsCategory_Get", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            ...
            objCommand = New SqlCommand("Web_ItemsCategoryPageCount_Get", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Sub Refresh_NextPage()
        ...
        Dim objCommand As New SqlCommand("Web_ItemsCategory_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.CommandTimeout = ConfigurationSettings.AppSettings("QueryTimeout")
