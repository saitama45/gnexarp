<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_account_receivables.aspx.vb" Inherits="srx.rep_account_receivables" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 40px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium"><asp:label id="lblTitle" runat="server" ForeColor="Red" CssClass="w3-bar-item">AR Report</asp:label></b>
				</div>
				<!-- End Header -->				
				<hr class="w3-bottombar w3-border-deep-purple">
					<div class="w3-row w3-section">
						<div class="w3-half">
							...
							<asp:listbox id="lstARBy" runat="server" SelectionMode="Single" CssClass="ddl" AutoPostback="True">
								<asp:ListItem Value="DetPerAccountName" Selected="True">Account Name (Detail)</asp:ListItem>
								<asp:ListItem Value="MonPerAccountName">Account Name (Monthly)</asp:ListItem>															
							</asp:listbox>
						</div>
						<div style="display:none">
							<div class="w3-third">
								<div class="w3-col" style="WIDTH:100px">Delivered Date From:</div>
									<div class="w3-rest">
						...
						<div class="w3-half">
							<div class="w3-col" style="WIDTH:100px">As of:</div>
								<div class="w3-rest">									
				...
				<p>
					<div class="w3-row w3-section">
						...
						<div class="w3-third">
							<asp:label id="lblYear" runat="server" class="w3-col s6" style="WIDTH:100px" Visible="False">Year:</asp:label>
							<asp:dropdownlist id="ddlYear" runat="server" Visible="False" Width="20%" CssClass="w3-input w3-text-small w3-mobile myddl"></asp:dropdownlist>
						</div>
						<div class="w3-third">
							<div class="w3-col s6" style="WIDTH:100px">Account Name:</div>
							<asp:listbox id="lstCustomer" runat="server" CssClass="ddl" SelectionMode="Multiple"></asp:listbox>
						</div>				
					</div>
				<P></P>
				<hr>
