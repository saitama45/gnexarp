...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lstBU As System.Web.UI.WebControls.ListBox
...
#End Region
    ...
    Public strSubMenuName As String = "rep_remittance"
    Public strStoredProc As String = "rep_remittance"
    Public strSubMenuFullView As String = "rep_remittance_popup"
    ...
    Public strFileNameExcel As String = "RemittanceReport.xls"
    Public strFileNamePDF As String = "RemittanceReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            objCommand.Parameters.Add("@Session_username", Session("username"))
            objReader = objCommand.ExecuteReader
            lstBU.DataSource = objReader
            lstBU.DataValueField = "code"
            lstBU.DataTextField = "name"
            lstBU.DataBind()
            objReader.Close()
            ...
            lstSalesPerson.DataValueField = "code"
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        BUValue = "0"
        For Each item As ListItem In lstBU.Items
            If item.Selected Then
