<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_customergroups_list.aspx.vb" Inherits="srx.ref_customergroups_list" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">
					...
					<b class="w3-medium">&nbsp;Customer Group</b>
				</div>
				<!-- End Header -->
