...
Public Class inv_payvoucher_list
...
#End Region
    ...
    Public strSubMenuName As String = "inv_payvoucher_list"
    Public strStoredProc As String = "inv_payvoucher_list"
    Public strStoredProcPageCount As String = "Inv_PayVoucherPageCount_Get"
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_payvoucherdtl_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_payvoucherdtl_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
    ...
    Private Sub Refresh_VoucherNo()
        ...
        Dim objCommand As New SqlCommand("Inv_PayVoucherNo_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
