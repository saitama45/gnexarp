...
Public Class inv_journalvoucher_list
...
#End Region
    ...
    Public strSubMenuName As String = "inv_journalvoucher_list"
    Public strStoredProc As String = "inv_journalvoucher_list"
    Public strStoredProcPageCount As String = "Inv_JournalVoucherPageCount_Get"
    ...
    Private Sub ClearInputs()
        ...
        calDate.SelectedDate = Date.UtcNow.AddHours(8)
        calDate.Enabled = True

        calDueDate.SelectedDate = Date.UtcNow.AddHours(8)
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_JournalVoucher_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_JournalVoucher_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@company", ddlCompany.SelectedValue)
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_journalvoucherdtl_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_journalvoucherdtl_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)

        End If
    End Sub

    Private Sub Refresh_VoucherNo()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))
        objConnection.Open()

        Dim objCommand As New SqlCommand("Inv_JournalVoucherNo_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
