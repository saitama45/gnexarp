<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_coa_list.aspx.vb" Inherits="srx.ref_coa_list" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">
					...
					<b class="w3-medium">&nbsp;Chart of Accounts</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='ref_coa_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							<P><LABEL><B></B></LABEL><BR>
								<asp:label id="lblID" runat="server" CssClass="w3-tag w3-red" Visible="False"></asp:label></P>
							<P><LABEL><B>Code</B></LABEL><BR>
								<asp:textbox id="txtCOACode" runat="server" Width="100%" Placeholder="Type here..." required onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
							</P>
							<P><LABEL><B>Account Title</B></LABEL><BR>
								<asp:textbox id="txtAccountTitle" runat="server" Width="100%" Placeholder="Type here..." required onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
							</P>
							<P><LABEL><B>Classification</B></LABEL><BR>
								<asp:dropdownlist id="ddlClass" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl" required></asp:dropdownlist>
							</P>
							<P><LABEL><B>Sub Classification</B></LABEL><BR>
								<asp:dropdownlist id="ddlSubClass" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl" required></asp:dropdownlist>
							</P>
						</DIV>
				...
				<asp:panel id="panelGrid" style="Z-INDEX: 0;" runat="server" Visible="True">
					...
					<div class="w3-responsive">
						<TABLE id="tblGroupList" class="w3-table-all w3-hoverable" cellSpacing="0" cellPadding="2"
							...
							<tr>
								<th>
									<asp:datagrid id="DataGrid" runat="server" ShowFooter="False" CellPadding="3" Width="100%" Height="24px" BackColor="White"
