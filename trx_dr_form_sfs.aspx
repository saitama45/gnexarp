<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form_sfs.aspx.vb" Inherits="srx.trx_dr_form_sfs" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.pr_code { FONT-SIZE: 12px; POSITION: absolute;PADDING-LEFT: 59em; TOP: 54px; width: 100%; }
			DIV.pr_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 59em; TOP: 72px; width: 100%; }
			DIV.invoice_no { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 59em; TOP: 91px; width: 100%; display:none }

			DIV.vendor_name { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 86px }
			DIV.vendor_code { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 110px }
			DIV.email { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 128px }			
			DIV.vendor_contact { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 120px; display:none }
			DIV.vendor_contactno { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 140px; display:none }
			DIV.vendor_address { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 160px; display:none }
			DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 180px; display:none }
			DIV.terms { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 46em; TOP: 164px; display:none }
			DIV.discount { FONT-SIZE: 12px; PADDING-LEFT: 50em;}
			SPAN.discount {FONT-SIZE: 12px; FONT-WEIGHT: bold}
			DIV.discounted_amount { FONT-SIZE: 12px; PADDING-LEFT: 50em;}
			SPAN.discounted_amount {FONT-SIZE: 12px; FONT-WEIGHT: bold}
			DIV.net_amount { FONT-SIZE: 12px; PADDING-LEFT: 50em;}
			SPAN.net_amount {FONT-SIZE: 15px; FONT-WEIGHT: bold}
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				<div class="image_header">
					<img src="./images/drform_sfs.jpg" alt="receivingform" class="img_background" >
