...
Public Class rep_subcategories
...
#End Region
    ...
    Public strSubMenuName As String = "rep_subcategories"
    Public strStoredProc As String = "rep_subcategories"
    Public strSubMenuFullView As String = "rep_subcategories_popup"
    ...
    Public strFileNameExcel As String = "SubCategoriesInventoryReport.xls"
    Public strFileNamePDF As String = "SubCategoriesInventoryReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'get the list of BU
            Dim objCommand As New SqlCommand("ref_subcategory_get_droplist", objConnection)
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        objCommand.Parameters.Add("@subcategory", lstSubCategories.SelectedValue)
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        Dim aColumns() As String = {"subcategory", _                                    
                                    "stock"}


        'the headers to diplay, instead of the default fieldname

        Dim aHeaders() As String = {"SubCategory", _                                    
                                    "Stock"}
