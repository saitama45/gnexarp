<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_dr_list.aspx.vb" Inherits="srx.inv_dr_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Issuance</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">												
							<%response.write("<a class='w3-hover-blue' href='inv_dr_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>Issued To</B></LABEL><BR>
								<asp:dropdownlist id="ddlClient" runat="server" CssClass="w3-tag w3-input w3-border w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
							</P>
							<P><LABEL><B>DR No.</B></LABEL><BR>							
								<asp:textbox id="txtDRNo" runat="server" CssClass="w3-input w3-white w3-border"></asp:textbox>
							</p>
							<P><LABEL><B>DR Date</B></LABEL><BR>							
								<ew:calendarpopup id="calDRDate" style="Z-INDEX: 0" runat="server" Width="53%"
							...
							<p>
								<asp:CheckBox id="chbTerms" runat="server" Text=" Terms" CssClass="w3-bold" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;
								<asp:textbox id="txtTerms" runat="server" CssClass="w3-input w3-white w3-border" Visible="False"></asp:textbox>
							</p>
