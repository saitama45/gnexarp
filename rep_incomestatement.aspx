<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_incomestatement.aspx.vb" Inherits="srx.rep_incomestatement" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Income Statement" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row w3-section">
						...
						<div class="w3-third" style="display:none">
							<div class="w3-col s6" style="WIDTH:100px">Voucher Type:</div>
				...
				<p>
					...
					<asp:button id="btnPrint" runat="server" Text="Print Income Statement" CssClass="w3-btn w3-bar-item w3-blue w3-mobile"></asp:button>
				</p>
				<hr class="w3-bottombar w3-border-deep-purple">
				<!-- Sys Group Table -->
