...
Public Class rep_projectstatus
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblCompleted As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strSubMenuName As String = "rep_projectstatus"
    Public strStoredProc As String = "rep_projectstatus"
    Public strSubMenuFullView As String = "rep_projectstatus_popup"
    ...
    Public strFileNameExcel As String = "ProjectStatusReport.xls"
    Public strFileNamePDF As String = "ProjectStatusReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            calDateFrom.SelectedDate = Date.UtcNow.AddHours(8).AddYears(-1).ToShortDateString
            ...
            Dim objCommand As New SqlCommand("Ref_SONoCompany_Get_droplist", objConnection)
            ...
            objCommand = New SqlCommand("Ref_ClientsCompany_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@Session_username", Session("username"))
    ...
    Private Function TriggerStatus()
        ...
        Dim objCommand As New SqlCommand("Rep_ProjectTasks_Delayed", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@Session_username", Session("username"))
    ...
    Private Function Refresh_Boxes()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Rep_ProjectStatus_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        lblDelay.Text = Trim(objReader("delayed"))
        lblPending.Text = Trim(objReader("pending"))
        lblOnGoing.Text = Trim(objReader("on_going"))
        lblCompleted.Text = Trim(objReader("completed"))
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        For Each item As ListItem In lstCustomer.Items
            If item.Selected Then
                CustomerValue = CustomerValue + IIf(CustomerValue <> "", ",", "") + item.Value
                selected = selected + 1
            End If
        Next
        ...
        For Each item As ListItem In lstStatus.Items
            If item.Selected Then
                StatusValue = StatusValue + IIf(StatusValue <> "", ",", "") + item.Value
                selected = selected + 1
            End If
        Next
        ...
        objCommand.Parameters.Add("@so_no", MotherCompanyvalue)
        objCommand.Parameters.Add("@customer", CustomerValue)
        objCommand.Parameters.Add("@status", StatusValue)
