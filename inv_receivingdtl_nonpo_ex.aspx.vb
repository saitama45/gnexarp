...
Public Class inv_receivingdtl_nonpo_ex
...
#End Region
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_ItemDTLNPO_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Sub btnBackImg_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnBackImg.Click
        Response.Redirect("inv_receivingdtl_nonpoa?&id=" & Request("lbl_id") & "&sys_table=" & "inv_receiving_list")
    End Sub
    ...
    Private Sub btnX_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnX.Click                
        Response.Redirect("inv_receivingdtl_nonpoa?&id=" & Request("lbl_id") & "&sys_table=" & "inv_receivingdtl_nonpoa")
    End Sub
