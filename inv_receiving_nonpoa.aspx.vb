...
Public Class inv_receiving_nonpoa
...
#End Region
    ...
    Public strSubMenuName As String = "inv_receiving_nonpoa"
    Public strStoredProc As String = "inv_receiving_nonpoa"
    Public strStoredProcPageCount As String = "Inv_ReceivingNonPOPageCount_Get"
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_receivingdtl_nonpoa?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_receivingdtl_nonpoa?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
