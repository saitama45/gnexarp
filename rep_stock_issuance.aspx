<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_stock_issuance.aspx.vb" Inherits="srx.rep_stock_issuance" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-project-diagram"></i>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Stock Issuance Report" runat="server" ForeColor="Red"
					...
					<div class="w3-row w3-section">
						<div class="w3-quarter">
							...
							<asp:listbox id="lstDDL1" runat="server" SelectionMode="Multiple" CssClass="ddl">								
								...
								<asp:ListItem Value="IN TRANSIT">FOR DELIVERY</asp:ListItem>
								<asp:ListItem Value="DELIVERED">DELIVERED</asp:ListItem>								
							</asp:listbox>
						</div>
						<div class="w3-quarter">
							<div class="w3-col s6" style="WIDTH:100px">BU:</div>
