...
Public Class trx_podetail_cosmomed
...
#End Region
    ...
    Public strStoredProc As String = "Inv_PrintPreview_PO_COSMOMED"
    ...
    Public strDefaultSortKey As String = "sku_code"
    Public strKeyField As String = "sku_code"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                lblVAT.Visible = True
            End If
            lblVAT.Text = objReader("vat_amount_show")

            lblCurrency.Text = Trim(objReader("currency"))
            lblNetAmount.Text = objReader("net_amount_show")
            lblCreatedBy.Text = objReader("created_by")
            lblApprovedBy.Text = objReader("approved_by")

            'If Trim(objReader("currency")) <> "PHP" Then
            '    panelPHPNetAmount.Visible = True
            '    lblPHPNetAmount.Visible = True
            '    lblPHPNetAmount.Text = Trim(objReader("php_net_amount_show"))
            'Else
            '    panelPHPNetAmount.Visible = False
            '    lblPHPNetAmount.Visible = False
            'End If
            ...
            If Convert.IsDBNull(objReader("ven_contact")) Then
                lblVendorContactNo.Text = ""
            Else
                lblVendorContactNo.Text = objReader("ven_contact")
            End If
            ...
            objCommand = New SqlCommand("Inv_PRSubItemsTotalCost_Get", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@pr_id", Request("id"))
            ...
            panelPHPNetAmount.Visible = True
            lblPHPNetAmount.Visible = True
            lblPHPNetAmount.Text = Trim(objReader("total_cost_show"))

            objReader.Close()

            objCommand = New SqlCommand("Sys_Company_POLogo", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@id", Request("id"))
            objCommand.Parameters.Add("@Session_username", Session("username"))
            objReader = objCommand.ExecuteReader
