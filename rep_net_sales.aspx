<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_net_sales.aspx.vb" Inherits="srx.rep_net_sales" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 40px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium"><asp:label id="lblTitle" runat="server" ForeColor="Red" CssClass="w3-bar-item">Sales Report</asp:label></b>
				</div>
				<!-- End Header -->
					...
					<div class="w3-row w3-section">
						<div class="w3-third">
							...
							<asp:listbox id="lstSalesBy" runat="server" SelectionMode="Single" CssClass="ddl" AutoPostback="True">
								<asp:ListItem Value="SalesPerDay" Selected="True">Sales Per Day (Summary)</asp:ListItem>
								<asp:ListItem Value="SalesPerDayDet">Sales Per Day (Detail)</asp:ListItem>
								<asp:ListItem Value="DetPerAccountName">Account Name (Detail)</asp:ListItem>
								...
								<asp:ListItem Value="DetPerProduct">Product (Detail)</asp:ListItem>
								<asp:ListItem Value="SumPerProduct">Product (Summary)</asp:ListItem>	
								<asp:ListItem Value="DetPerBrand">Brand (Detail)</asp:ListItem>
								<asp:ListItem Value="SumPerBrand">Brand (Summary)</asp:ListItem>	
								<asp:ListItem Value="SalesPerson">Sales Person</asp:ListItem>							
							</asp:listbox>
						</div>
						<div class="w3-third">													
				...
				<p>
					<div class="w3-row w3-section">
						<div class="w3-third">
							<asp:label id="lblItem" runat="server" Visible="False">Item:</asp:label>
							<asp:listbox id="lstItem" runat="server" SelectionMode="Multiple" CssClass="ddl" Visible="False"></asp:listbox>
						</div>
						<div class="w3-third">
						...
						<div class="w3-third">
							<asp:label id="lblBusinessName" runat="server" Visible="False">Business Name:</asp:label>
							<asp:listbox id="lstBusinessName" runat="server" SelectionMode="Multiple" CssClass="ddl" Visible="False"></asp:listbox>
						</div>
						<div class="w3-third">
						...
						<div class="w3-third">
							<asp:label id="lblAccountName" runat="server" Visible="False">Account Name:</asp:label>
							<asp:listbox id="lstAccountName" runat="server" SelectionMode="Multiple" CssClass="ddl" Visible="False"></asp:listbox>
