...
Public Class inv_prequests_approval
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblPONetAmount As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strStoredProc As String = "Inv_PRequests_Approval"
    Public strStoredProc2 As String = "inv_pritems_list"
    Public strStoredProcPageCount As String = "Inv_PRequestApprovalPageCount_Get"
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_PRApproval_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            If txtFormAction.Text = "Approve" Then
                ...
                Sys_Class.SaveToAuditTrail(Session("username"), _
                                            ...
                                            strSubMenuName, _
                                            "Ref# " + lblID.Text + " > ApprovedBy: " + lblApprovedBy.Text + " > ApprovedDate: " + Date.UtcNow.AddHours(8), _
                                            lblID.Text, _
                                            0)
            ...
            ElseIf txtFormAction.Text = "Cancel" Then
                ...
                Sys_Class.SaveToAuditTrail(Session("username"), _
                                            txtFormAction.Text, _
                                            strSubMenuName, _
                                            "Ref# " + lblID.Text + " > CancelledBy: " + lblApprovedBy.Text + " > CancelledDate: " + Date.UtcNow.AddHours(8), _
                                            lblID.Text, _
                                            0)
            End If
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Approve" Then
            ...
            lblPONetAmount.Text = Trim(objReader("net_amount_show"))
            lblPONetAmount.Visible = True

            lblSupplierCode.Text = Trim(objReader("vendor_code"))
        ...
        ElseIf e.CommandName = "Cancel" Then
            ...
            lblPONetAmount.Text = Trim(objReader("net_amount"))
            lblPONetAmount.Visible = True
