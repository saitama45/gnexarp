<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_depleted_stocks.aspx.vb" Inherits="srx.rep_depleted_stocks" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Depleted Stocks Report" runat="server" ForeColor="Red"
