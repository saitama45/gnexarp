...
Public Class ref_fixedassets_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtUsefulLife As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Public strSubMenuName As String = "ref_fixedassets_list"
    Public strStoredProc As String = "ref_fixedassets_list"
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_FixedAssets_Get", objConnection)
        ...
        txtUsefulLife.Text = objReader("useful_life")
        
        objReader.Close()
        objConnection.Close()

        SetFocus(txtUsefulLife)
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_FixedAssets_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@useful_life", txtUsefulLife.Text)
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_FixedAssets_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@useful_life", txtUsefulLife.Text)    
