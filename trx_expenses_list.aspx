<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_expenses_list.aspx.vb" Inherits="srx.trx_expenses_list" %>
...
<HTML>
	...
	<body class="w3-light-grey">
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-money-check"></i>&nbsp;Expenses</b></h5>
					<div style="display:none;">
						<asp:Label ID="lblStatus" runat="server" Visible="True"></asp:Label>
						<asp:Label ID="lblSessionGroup" runat="server" Visible="True"></asp:Label>
					</div>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						...
						<%response.write("<a class='w3-hover-blue' href='trx_expenses_list'><span class='w3-button w3-large w3-hover-red w3-right'>x</span></a>")%>
							...
							<div class="w3-row">
								<div class="w3-half w3-container">
									<P><LABEL><B>Date</B></LABEL><BR>
										<ew:calendarpopup tabIndex="1" id="calRequestedDate" style="Z-INDEX: 0" runat="server"
								...
								<div class="w3-half w3-container">
									<P><LABEL><B>BU</B></LABEL><BR>
										<asp:dropdownlist id="ddlBU" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
									</P>
								</div>
							</div>	
							<div class="w3-row">
								<div class="w3-half w3-container">
									<P><LABEL><B>Requested By</B></LABEL><BR>
										<asp:textbox id="txtRequestedBy" runat="server" Width="100%" Placeholder="Type here..." required></asp:textbox>
									</P>
								</div>
								<div class="w3-half w3-container">
									<P><LABEL><B>Expense Type</B></LABEL><BR>
										<asp:dropdownlist id="ddlExpenseType" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
									</P>
								</div>
							</div>							
							<div class="w3-row">
								<div class="w3-half w3-container">
									<P><LABEL><B>Description</B></LABEL><BR>
										<asp:textbox id="txtDescription" runat="server" Width="100%" Placeholder="Type here..." required></asp:textbox>
									</P>
								</div>
								<div class="w3-half w3-container">
									<P><LABEL><B>Cost</B></LABEL><BR>
										<asp:textbox id="txtCost" runat="server" Width="100%" Placeholder="Type here..." CssClass="txtNumbers" required></asp:textbox>
									</P>
								</div>
							</div>
							<div class="w3-container">
								<P><LABEL><B>Note</B></LABEL><BR>
									<asp:textbox id="txtNote" runat="server" Width="100%" CssClass="w3-input" Placeholder="Type here..." TextMode="MultiLine" Maxlength="1000"></asp:textbox>
								</P>														
							</div>																																																																									
						</DIV>
		...
		<script>
			...
			$("#calRequestedDate").keyup(function (e) {
			...
			$(document).ready(function() {
				if ($('#lblSessionGroup').text() === "GENADMIN") {
					// Show the <a> tag in the first column
					$('td:nth-child(2):contains("POSTED")').prev('td').find('a').show();
				} else {
					// Hide the <a> tag in the first column
					$('td:nth-child(2):contains("POSTED")').prev('td').find('a').hide();
				}
			});
