<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_salespersons_list.aspx.vb" Inherits="srx.ref_salespersons_list" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;Sales Persons Lists</b>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>FullName</B></LABEL><BR>
								<asp:textbox tabIndex="1" id="txtName" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox></P>							
						</DIV>
