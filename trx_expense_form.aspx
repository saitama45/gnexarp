<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_expense_form.aspx.vb" Inherits="srx.trx_expense_form" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.code { FONT-SIZE: 12px; POSITION: absolute;PADDING-LEFT: 63em; TOP: 36px }
			DIV.requested_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 63em; TOP: 54px }
			DIV.needed_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 63em; TOP: 76px }	
			DIV.requested_by { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 19em; TOP: 123px }
			DIV.client { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 19em; TOP: 144px }
			DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 19em; TOP: 168px }					
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				<div class="image_header">
					<img src="./images/expenseform.jpg" alt="receivingform" class="img_background" >
				...
				<div class="needed_date">
					<asp:label id="lblNeededDate" runat="server"></asp:label>
				</div>
