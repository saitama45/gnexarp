...
Public Class inv_returns_approval
...
#End Region
    ...
    Public strSubMenuName As String = "inv_returns_approval"
    Public strStoredProc As String = "inv_returns_approval"
    Public strStoredProc2 As String = "inv_returnitems_list"
    Public strStoredProcPageCount As String = "Inv_ReturnsApprovalPageCount_Get"
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_ReturnApproval_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function ValidateInput()
        ...
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@dr_date", Date.UtcNow)
        objCommand.Parameters.Add("@id", lblID.Text)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Approve" Then
            ...
            lblTotalItems.Text = Trim(objReader("total_item"))
            lblTotalItems.Visible = True

            lblTotalQty.Text = Trim(objReader("total_qty"))
            lblTotalQty.Visible = True

            lblTotalCost.Text = Trim(objReader("total_cost"))
