...
Public Class ref_subitems_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btnUploadPic As System.Web.UI.WebControls.LinkButton
    Protected WithEvents txtQty As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblSRP As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP2 As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP3 As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP4 As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP5 As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP6 As System.Web.UI.WebControls.Label
    Protected WithEvents lblSRP7 As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strStoredProc As String = "ref_subitems_list"
    Public strSubMenuName As String = "ref_subitems_list"
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_SubItems_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        Dim strRawMats As String = objReader("sub_code")
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_SubItems_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        objCommand.Parameters.Add("@rm_code", lblCode.Text)
        objCommand.Parameters.Add("@sub_code", ddlRawMats.SelectedValue)
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_SubItems_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@item_id", lblItemID.Text)
        objCommand.Parameters.Add("@rm_code", lblCode.Text)
    ...
    Private Sub LoadSRP()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP")
        ...
        lblSRP.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP2()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP2")
        ...
        lblSRP2.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP3()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP3")
        ...
        lblSRP3.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP4()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP4")
        ...
        lblSRP4.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP5()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP5")
        ...
        lblSRP5.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP6()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP6")
        ...
        lblSRP6.Text = Trim(objReader("name"))

        objReader.Close()
        objConnection.Close()
    End Sub
    Private Sub LoadSRP7()
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))

        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_IndustrySRP_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@srp_code", "SRP7")
        ...
        lblSRP7.Text = Trim(objReader("name"))
    ...
    Private Sub btnX_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnX.Click
        Response.Redirect("ref_subitems_list?&id=" & Request("id") & "&sys_table=" & Request("sys_table"))
        panelGrid.Visible = True
        panelSuccess.Visible = False
        panelInfo.Visible = False
    End Sub
    ...
    Private Sub btnUploadPic_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUploadPic.Click
        Response.Redirect("ref_picitems_list?&id=" & Request("id") & "&sys_table=" & strStoredProc)
    End Sub
End Class
