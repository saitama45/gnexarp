<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_payvouchercheckhdr_list.aspx.vb" Inherits="srx.inv_payvouchercheckhdr_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Disbursement</b></h5>
				</div>
				<!-- End Header -->
				<!-- #include file ="html\AlertPanel.html" -->
				<!-- Input Form -->
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 750px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%
								response.write("<a class='w3-hover-blue' href='inv_payvouchercheckhdr_list'><span class='w3-button w3-hover-red w3-display-topright'>X</span></a>")
							%>	
							<br><br>					
						</HEADER>
						<DIV class="w3-container w3-section w3-medium">
							<div style="display:none">
								<asp:label id="lblID" runat="server" CssClass="w3-tag w3-red" Visible="False"></asp:label>								
									...
									<asp:label id="lblDebit" runat="server" CssClass="w3-large"></asp:label>
									<asp:label id="lblPayableAmount" runat="server" CssClass="w3-large"></asp:label>
								</H2>
							</div>	
							<div class="w3-row">
								<asp:ImageButton id="btnPrintImg" runat="server" ImageUrl="images/printbtn.png" Tooltip="Check Voucher" CssClass="btnImg w3-bar-item w3-hover-opacity w3-right" />
								<div class="w3-half w3-container">
									<P><LABEL><B>Voucher No.</B></LABEL><BR>
										<asp:label id="lblVoucherNo" runat="server" CssClass="w3-large"></asp:label>
									</P>
								</div>
								<div class="w3-half w3-container">
									<P><LABEL><B>Payable</B></LABEL><BR>
										<asp:label id="lblPayableShow" runat="server" CssClass="w3-large"></asp:label>
										<asp:label id="lblPayable" runat="server" CssClass="w3-large" Visible="False"></asp:label>
									</P>
								</div>
							</div>	
							<div class="w3-row">
								<div class="w3-half w3-container">
									<P><LABEL><B>Check No.</B></LABEL><BR>
										<asp:textbox id="txtCheckNo" CssClass="w3-input" runat="server" Placeholder="Type here..."></asp:textbox>
									</P>
								</div>
								<div class="w3-half w3-container">
									<P>
										<b><asp:CheckBox id="chbCheckDate" runat="server" Text=" Check Date" CssClass="w3-bold" Checked="True" AutoPostBack="True"></asp:CheckBox></b>&nbsp;
										<ew:calendarpopup tabIndex="1" id="calCheckDate" style="Z-INDEX: 0" runat="server" Width="53%"
							...
							<div class="w3-row">
								<div class="w3-half w3-container">
									<P><LABEL><B>Ref No.</B></LABEL><BR>
										<asp:textbox id="txtCashVoucherNo" CssClass="w3-input" runat="server" Placeholder="Type here..."></asp:textbox>
									</P>
								</div>
								<div class="w3-half w3-container">
									<P>
										<b><asp:CheckBox id="chbCashVoucherDate" runat="server" Text=" Ref Date" CssClass="w3-bold" Checked="True" AutoPostBack="True"></asp:CheckBox></b>&nbsp;
										<ew:calendarpopup tabIndex="1" id="calCashVoucherDate" style="Z-INDEX: 0" runat="server" Width="53%"
											Height="30px" ShowGoToToday="True" CalendarLocation="Bottom" AllowArbitraryText="False" DisableTextboxEntry="False"
											ImageUrl="images/calendar-icon-mac.jpg" ControlDisplay="TextBoxImage">
											<WeekdayStyle Font-Size="Medium" Font-Names="Verdana,Helvetica,Tahoma,Arial" ForeColor="Black"
												BackColor="White"></WeekdayStyle>
