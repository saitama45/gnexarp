<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" Codebehind="ref_currencies_list.aspx.vb" Inherits="srx.ref_currencies_list" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;Currencies</b>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='ref_currencies_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P><LABEL><B>Name</B></LABEL><BR>
								<asp:textbox tabIndex="1" id="txtName" runat="server" Width="100%" Placeholder="Type here..." required onkeypress="return clickButton(event,'btnSave')"></asp:textbox></P>							
							<P><LABEL><B>Code</B></LABEL><BR>
								<asp:textbox tabIndex="1" id="txtCode" runat="server" Width="100%" Placeholder="Type here..." required onkeypress="return clickButton(event,'btnSave')"></asp:textbox></P>							
							<P><LABEL><B>Symbol</B></LABEL><BR>
								<asp:textbox tabIndex="1" id="txtSymbol" runat="server" Width="100%" Placeholder="Type here..." required onkeypress="return clickButton(event,'btnSave')"></asp:textbox></P>								
						</DIV>
