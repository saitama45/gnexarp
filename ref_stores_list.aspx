<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_stores_list.aspx.vb" Inherits="srx.ref_stores_list" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='ref_stores_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
