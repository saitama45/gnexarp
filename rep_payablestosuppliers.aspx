<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_payablestosuppliers.aspx.vb" Inherits="srx.rep_payablestosuppliers" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-project-diagram"></i>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Payables To Suppliers Report" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row">
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">PO Date From:</div>
								<div class="w3-rest">
						...
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">PO Date To:</div>
								<div class="w3-rest">
				...
				<p>
					<div class="w3-row w3-section">
						...
						<div class="w3-third">
							<div class="w3-col s6" style="WIDTH:100px">Supplier:</div>
