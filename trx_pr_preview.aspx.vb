...
#End Region
    ...
    Public strStoredProc As String = "Inv_PrintPreview_PR"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblBU.Text = Trim(objReader("name"))
            lblBUShippingAddress.Text = Trim(objReader("address"))
            lblBUName.Text = Trim(objReader("name"))
