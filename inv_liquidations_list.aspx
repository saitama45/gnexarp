<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="inv_liquidations_list.aspx.vb" Inherits="ems.inv_liquidations_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left">						
						<b><i class="fas fa-file-invoice"></i>&nbsp;Liquidations</b>
					</h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0;" runat="server" Visible="False">				
					<DIV id="id01" class="w3-card-4" style="margin: auto; MAX-WIDTH: 600px">												
						...
						<DIV class="w3-section w3-medium">							
							...
							<div class="w3-row">
								...
								<div class="w3-half w3-container">
									<LABEL><B>RF No.</B></LABEL><BR>
										<asp:textbox id="txtRFNo" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Type RF No."></asp:textbox>									
								</div>								
							</div>
							<br>	
							<div class="w3-row">
							...
							<div class="w3-row">
								<div class="w3-half w3-container">
									<LABEL><B>Requested Date</B></LABEL><BR>
								...
								<div class="w3-half w3-container">									
									<b><asp:CheckBox id="chbNeededDate" runat="server" Text=" Needed Date" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;</b>
									<br>									
							...
							<div class="w3-row">
								<div class="w3-half w3-container">
									<LABEL><B>Budget Holder</B></LABEL><BR>
										<asp:textbox id="txtBudgetHolder" runat="server" CssClass="w3-input w3-border" required></asp:textbox>	
								</div>
								<div class="w3-half w3-container">
						...
						<div class="w3-cell-row">
							<div class="w3-bar w3-margin-right w3-mobile w3-responsive">
								<p>    
									...
									<%response.write("<a class='w3-btn w3-blue w3-hover-light-blue w3-mobile w3-right' style='width:12%' href='rep_liquidation'>Liquidation Report</a>")%>
