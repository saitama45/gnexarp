...
Public Class rep_undelivered_dr
...
#End Region
    ...
    Public strSubMenuName As String = "rep_undelivered_dr"
    Public strStoredProc As String = "rep_undelivered_dr"
    Public strSubMenuFullView As String = "rep_undelivered_dr_popup"
    ...
    Public strFileNameExcel As String = "UndeliveredDRReport.xls"
    Public strFileNamePDF As String = "UndeliveredDRReport.pdf"
