...
Public Class rep_budgetrequests
...
#End Region
    ...
    Public strSubMenuName As String = "rep_budgetrequests"
    Public strStoredProc As String = "rep_budgetrequests"
    Public strSubMenuFullView As String = "rep_budgetrequests_popup"
    ...
    Public strFileNameExcel As String = "BudgetRequestsReport.xls"
    Public strFileNamePDF As String = "BudgetRequestsReport.pdf"
