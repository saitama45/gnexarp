...
Public Class inv_delivery_update
...
#End Region
    ...
    Public strSubMenuName As String = "inv_delivery_update"
    Public strStoredProc As String = "Inv_Delivery_Update"
    Public strStoredProc2 As String = "Inv_IssuedItems_List"
    Public strStoredProcPageCount As String = "Inv_DeliveryUpdatePageCount_Get"
    ...
    Private Sub ReadyEdit()
        ...
        Dim bolChangeable As Boolean = objReader("status") = "POSTED" Or objReader("status") = "FOR DELIVERY" Or objReader("status") = "DELIVERED"
        ...
        txtDeliveryCost.Text = Trim(objReader("delivery_cost"))
        txtDeliveryCost.Enabled = bolChangeable
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_Delivery_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
