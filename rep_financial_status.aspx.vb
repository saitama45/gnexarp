...
Public Class rep_financial_status
...
#End Region
    ...
    Public strSubMenuName As String = "rep_financial_status"
    Public strStoredProc As String = "rep_financial_status"
    Public strStoredProc2 As String = "rep_ar_monthly"
    Public strSubMenuFullView As String = "rep_financial_status_popup"
    ...
    Public strFileNameExcel As String = "FinancialStatusReport.xls"
    Public strFileNamePDF As String = "FinancialStatusReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lstCustomer.DataValueField = "name"
            lstCustomer.DataTextField = "code"
            lstCustomer.DataBind()
            lstCustomer.SelectedValue = Date.UtcNow.AddHours(8).Year
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        objCommand.Parameters.Add("@mode", lstARBy.SelectedValue)
        objCommand.Parameters.Add("@year", lstCustomer.SelectedValue)
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        If lstARBy.SelectedValue = "1" Then
        ...
        ElseIf lstARBy.SelectedValue = "2" Then

            Dim aColumns() As String = {"type", _
                                        "q1", _
                                        "q2", _
                                        "q3", _
                                        "q4", _
            ...
            Dim aHeaders() As String = {"Category", _
                                        "Q1", _
                                        "Q2", _
                                        "Q3", _
                                        "Q4", _
