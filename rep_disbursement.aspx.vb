...
#End Region
    ...
    Public strSubMenuName As String = "rep_disbursement"
    Public strStoredProc As String = "rep_disbursement"
    Public strSubMenuFullView As String = "rep_disbursement_popup"
    ...
    Public strFileNameExcel As String = "DisbursementReport.xls"
    Public strFileNamePDF As String = "DisbursementReport.pdf"
