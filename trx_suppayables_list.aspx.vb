...
Public Class trx_suppayables_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents calRefDate As eWorld.UI.CalendarPopup
    ...
    Protected WithEvents txtSupSINo As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Public strSubMenuName As String = "trx_suppayables_list"
    Public strStoredProc As String = "trx_suppayables_list"
    ...
    Private Sub ReadyEdit()
        ...
        txtRefNo.Text = Trim(objReader("ref_code"))
       
        calRefDate.SelectedDate = objReader("ref_date")
        calRefDate.VisibleDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calRefDate.Enabled = bolChangeable

        txtDetails.Text = objReader("note")
        txtDetails.Enabled = bolChangeable

        txtSupSINo.Text = objReader("vendor_sino")
        txtSupSINo.Enabled = bolChangeable

        calSupSIDate.SelectedDate = objReader("vendor_sidate")
        calSupSIDate.VisibleDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calSupSIDate.Enabled = bolChangeable
    ...
    Private Sub ReadyDelete()
        ...
        calRefDate.SelectedDate = objReader("ref_date")
        calRefDate.VisibleDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calRefDate.Enabled = False

        txtDetails.Text = objReader("note")
        txtDetails.Enabled = False

        txtSupSINo.Text = objReader("vendor_sino")
        txtSupSINo.Enabled = False

        calSupSIDate.SelectedDate = objReader("vendor_sidate")
        calSupSIDate.VisibleDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calSupSIDate.Enabled = False
    ...
    Private Sub ClearInputs()
        ...
        calRefDate.SelectedDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calRefDate.Enabled = True
        ...
        txtSupSINo.Text = ""
        txtSupSINo.Enabled = True

        calSupSIDate.SelectedDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calSupSIDate.Enabled = True

        ddlCurrency.SelectedValue = "PESO"
    ...
    Private Function SaveInput()
        ...
        objCommand.Parameters.Add("@ref_code", txtRefNo.Text)
        objCommand.Parameters.Add("@ref_date", calRefDate.SelectedDate)
        objCommand.Parameters.Add("@vendor_code", ddlVendor.SelectedValue)        
        objCommand.Parameters.Add("@note", txtDetails.Text)
        objCommand.Parameters.Add("@vendor_sino", txtSupSINo.Text)
        ...
        Try
            ...
            Sys_Class.SaveToAuditTrail(Session("username"), _
                                        ...
                                        strSubMenuName, _
                                        "Ref# " + lblID.Text + " > PODate: " + Date.UtcNow.AddHours(8).ToShortDateString + " > VendorCode: " + strVendorCode + " > Details: " + txtDetails.Text + " > SI#: " + txtSupSINo.Text + " > SupplierSIDate: " + calSupSIDate.SelectedDate + " > Amount: " + txtAmount.Text, _
                                        objNewID.Value, _
                                        0)
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("trx_suppayments_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("trx_suppayments_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
