...
Public Class inv_procurement_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblCancelled As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strSubMenuName As String = "inv_procurement_list"
    Public strStoredProc As String = "inv_procurement_list"
    Public strStoredProcPageCount As String = "Inv_ProcurementPageCount_Get"

    Public strFileNameExcel As String = "ProcurementStatus.xls"
    ...
    Private Function Refresh_Boxes()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_ProcurementBox_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        lblCancelled.Text = Trim(objReader("cancelled"))
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_procurementdtl_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
    ...
    Private Sub btnDownload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDownload.Click
        ...
        Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))
        Dim objCommand As New SqlCommand("Inv_Procurement_Export", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
