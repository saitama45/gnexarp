<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_soa.aspx.vb" Inherits="srx.rep_soa" %>
...
<HTML>
	...
	<body class="w3-light-grey">
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="SOA Report" runat="server" ForeColor="Red"
				...
				<p>
					...
					<asp:radiobuttonlist id="rdoAccount" style="Z-INDEX: 0" runat="server" AutoPostBack="True">
						<asp:ListItem Value="0" Selected="True">Business Name</asp:ListItem>
					...
					<div class="w3-row w3-section">
						...
						<asp:panel id="panelAccountName" runat="server" Visible="False">
							<div class="w3-third">
								<div class="w3-col s6" style="WIDTH:100px">Account Name:</div>
								<asp:listbox id="lstCustomer" runat="server" SelectionMode="Single"></asp:listbox>
							</div>
						</asp:panel>
						<asp:panel id="panelBusinessName" runat="server" Visible="True">
							<div class="w3-third">
								<div class="w3-col s6" style="WIDTH:100px">Business Name:</div>
								<asp:listbox id="lstBusinessName" runat="server" SelectionMode="Single"></asp:listbox>
							</div>				
						</asp:panel>
					</div>
				<P></P>
				...
				<p>
					...
					<asp:button id="btnPrint" runat="server" Text="Print SOA" CssClass="w3-btn w3-bar-item w3-blue w3-mobile"></asp:button>
				</p>
				<hr class="w3-bottombar w3-border-deep-purple">
				<!-- Sys Group Table -->
		...
		<script type="text/javascript">
			$(function () {				
				$('#lstCustomer, #lstBusinessName').multiselect({
