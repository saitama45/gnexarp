<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_collections.aspx.vb" Inherits="srx.rep_collections" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Collections Report" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row">
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">OR Date From:</div>
								<div class="w3-rest">
						...
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">OR Date To:</div>
								<div class="w3-rest">
