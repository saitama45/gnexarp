<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form_cmi_itemized.aspx.vb" Inherits="srx.trx_dr_form_cmi_itemized" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.pr_code { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 40em; TOP: 205px }
			DIV.pr_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 225px }
			DIV.terms { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 225px; display:none;}

			DIV.vendor_name { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 1em; TOP: 145px }
			DIV.vendor_contact { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 205px; display:none;}
			DIV.vendor_contactno { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 185px; display:none; }
			DIV.email { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 225px; display:none; }			
			DIV.vendor_address { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 245px; }
			
			/* DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 425px; } */
			DIV.requested_by { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 1em; TOP: 265px; display:none; }
			...
			SPAN.vat {FONT-SIZE: 12px; width: 120px; text-align: right; display: inline-block; display:none}	
			SPAN.vatlabel { FONT-SIZE: 12px; MARGIN-LEFT: 48em; width: 150px; display: inline-block; display:none}
			...
			LABEL.discounted_amount { FONT-SIZE: 12px; MARGIN-LEFT: 48em; width: 150px; display: inline-block;display:none}
			SPAN.discounted_amount {FONT-SIZE: 12px; width: 120px; text-align: right; display: inline-block;display:none}	
				
			LABEL.net_amount { FONT-SIZE: 12px; MARGIN-LEFT: 48em; width: 150px; display: inline-block;display:none}
			SPAN.net_amount {FONT-SIZE: 12px; FONT-WEIGHT: bold; width: 120px; text-align: right; display: inline-block;display:none}
	...
	<body>				
		...
		<div class="datagrid">			
			...
			<div class="net_amount">
				<label class="net_amount">Net Sales:</label>
				<asp:label id="lblNetSales" runat="server" CssClass="net_amount"></asp:label>
			</div>
		...
		<div class="header">
			<div class="image_header">					
				...
				<div>
					<label class="form_title">DELIVERY RECEIPT</label>
				</div>	
			...
			<div class="pr_code">
				<LABEL class="header_class"><B>DR Number:</B></LABEL>				
				<asp:label id="lblPRCode" runat="server"></asp:label>
			</div>						
			<div class="pr_date">
				<LABEL class="header_class">DR Date:</LABEL>
