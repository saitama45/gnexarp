<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_itemdtl_list.aspx.vb" Inherits="srx.inv_itemdtl_list" %>
					...
					<DIV id="id01" class="w3-card-4 w3-third myForm">
						...
						<DIV class="w3-medium" id="mydivheader">
							...
							<div class="w3-container">
								<div class="w3-row">
									<div class="w3-half">
										...
										<asp:textbox id="txtSerial" runat="server" Placeholder="type here..." CssClass="w3-input" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
									<div class="w3-half">										
							...
							<div class="w3-container" style="display:none;">
								<div class="w3-row">
									<div class="w3-half">
										...
										<asp:textbox id="txtEngineNo" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
									<div class="w3-half">
										<LABEL><B>Frame #</B></LABEL><BR>
										<asp:textbox id="txtFrameNo" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
								</div>
							</div>	
							...
							<div class="w3-container" style="display:none;">
								<div class="w3-row">
									<div class="w3-half">
										...
										<asp:textbox id="txtColor" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
									<div class="w3-half">
										<LABEL><B>Model #</B></LABEL><BR>
										<asp:textbox id="txtModelNo" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
								</div>
							</div>	
							<br>
							<div class="w3-container" style="display:none;">
								<div class="w3-row">
									<div class="w3-half">
										<LABEL><B>Chasis #</B></LABEL><BR>
										<asp:textbox id="txtChasisNo" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
									<div class="w3-half">
										<LABEL><B>Remarks</B></LABEL><BR>
										<asp:textbox id="txtRemarks" runat="server" Placeholder="type here..." CssClass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
								</div>
							</div>																
							<div class="w3-container" style="display:true;">
								<div class="w3-row">
									<div class="w3-half">
										<asp:CheckBox id="chbNoExpiryDate" runat="server" Text=" w/o Expiry" Checked="True" AutoPostBack="True"></asp:CheckBox>&nbsp;
									</div>
									<div class="w3-half">
								...
								<div class="w3-row">
									<div class="w3-half">
										<LABEL><B>Received Qty</B></LABEL><BR>
											<asp:textbox id="txtActualQty" runat="server" required Cssclass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
									<div class="w3-half">
										<LABEL><B>Free Qty Received</B></LABEL><BR>
											<asp:textbox id="txtFreeQty" runat="server" required Cssclass="w3-input w3-border" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</div>
								</div>	
							</div>	
							<br>						
							<asp:panel id="panelCost" style="Z-INDEX: 0" runat="server" Visible="False">
								<div class="w3-container">
									<P><LABEL><B>Cost</B></LABEL><BR>
										<asp:textbox id="txtCost" runat="server" Placeholder="type here..." CssClass="w3-input" onkeypress="return clickButton(event,'btnSave')"></asp:textbox>
									</P>
								</div>	
							</asp:panel>																									
						</DIV>
				...
				<div class="w3-row">
					<div class="w3-third">
						<div class="w3-container w3-teal">
							...
							<p>
								Free Qty:&nbsp;
								<asp:label id="lblTotalFreeQty" class="w3-rest s6 w3-medium" runat="server" Font-Bold="True"></asp:label>								
							</p>																				
							<p>
								Note:&nbsp;
