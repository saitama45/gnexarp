<%@ Page Language="vb" AutoEventWireup="true" Codebehind="inv_procurementdtl_list.aspx.vb" Inherits="srx.inv_procurementdtl_list" %>
...
<HTML>
	...
	<!-- #include file ="html\BodyColor.html" -->
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main">
				...
				<div style="MARGIN-TOP: 40px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Procurement Items</b></h5>
				</div>
				<!-- End Header -->
				<!-- #include file ="html\AlertPanel.html" -->
				<!-- Input Form -->
				<div class="center">
					<asp:label id="lblSelectedVendor" runat="server" Visible="False"></asp:label>
					<asp:button id="btnYes" runat="server" CssClass="w3-btn w3-blue w3-margin-right" Text="Yes" Visible="False"></asp:button>
					<asp:button id="btnNo" runat="server" UseSubmitBehavior="False" CssClass="w3-btn w3-red" Text="No" Visible="False"></asp:button>
				</div>				
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4 myForm w3-mobile w3-responsive">
						...
						<DIV class="w3-medium" id="mydivheader">
							...
							<div class="w3-container w3-row">
								<div class="w3-third">
									<LABEL><B>Requested Qty</B></LABEL><br>							
									<asp:label id="lblRequestedQty" runat="server"></asp:label>
								</div>
								<div class="w3-third">
									<LABEL><B>SOH</B></LABEL><br>			
									<asp:label id="lblSOH" class="w3-rest s6 w3-medium" runat="server"></asp:label>											
								</div>		
								<div class="w3-third">
									<LABEL><B>For PO Qty</B></LABEL>								
									<asp:textbox id="txtForPOQty" runat="server" CssClass="w3-input" Placeholder="0.00"></asp:textbox>
								</div>						
							</div>
							<br>
							<div class="w3-row">
								<div class="w3-third w3-padding">
									<LABEL><B>Supplier A</B></LABEL><br>								
									<asp:CheckBox id="chbSupplierA" runat="server" CssClass="checkbox-group" Checked="False"></asp:CheckBox>&nbsp;
									<asp:textbox id="txtVendorCost1" runat="server" CssClass="w3-input" Placeholder="0.00"></asp:textbox>
								</div>
								<div class="w3-third w3-padding">
									<LABEL><B>Supplier B</B></LABEL><br>	
									<asp:CheckBox id="chbSupplierB" runat="server" CssClass="checkbox-group" Checked="False"></asp:CheckBox>&nbsp;							
									<asp:textbox id="txtVendorCost2" runat="server" CssClass="w3-input" Placeholder="0.00"></asp:textbox>
								</div>
								<div class="w3-third w3-padding">
									<LABEL><B>Supplier C</B></LABEL><br>	
									<asp:CheckBox id="chbSupplierC" runat="server" CssClass="checkbox-group" Checked="False"></asp:CheckBox>&nbsp;							
									<asp:textbox id="txtVendorCost3" runat="server" CssClass="w3-input" Placeholder="0.00"></asp:textbox>
								</div>
							</div>																	
						</div>	
					...
					<div class="w3-row">
						<div class="w3-third">
							<div class="w3-container w3-blue">	
								...
								<p>
									Project Name:&nbsp;									
									<asp:label id="lblProjectName" class="w3-rest s6 w3-medium" runat="server" Font-Bold="True">0</asp:label>
								</p>
								<p>
									Account Name:&nbsp;		
								...
								<p>
									<label class="w3-bar-item w3-left">Supplier A:&nbsp;</label>
									<asp:LinkButton id="btnCreatePOSupA" OnClientClick="return confirm('Are you sure you want to proceed?');" CssClass="w3-btn w3-ripple w3-small w3-round w3-green w3-bar-item w3-right w3-mobile"
										runat="server" Visible="True">&nbsp;Create PO</asp:LinkButton>
									<br>
									<div class="dropdown-container">
										<asp:dropdownlist id="ddlSupplierA" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
										<asp:label id="lblSupplierAName" runat="server" Visible="False"></asp:label>
									</div>		
									<asp:CheckBox id="chbSupANotFound" runat="server" Text=" New?" CssClass="w3-left w3-bar-item" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;									
									<asp:textbox id="txtSupplierA" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Supplier Name" Autopostback="True" Visible="False"></asp:textbox>
								</p>								
								<p>
									<label class="w3-bar-item w3-left">Supplier B:&nbsp;</label>
									<asp:LinkButton id="btnCreatePOSupB" OnClientClick="return confirm('Are you sure you want to proceed?');" CssClass="w3-btn w3-ripple w3-small w3-round w3-green w3-bar-item w3-right w3-mobile"
										runat="server" Visible="True">&nbsp;Create PO</asp:LinkButton>		
									<br>																		
									<div class="dropdown-container">
										<asp:dropdownlist id="ddlSupplierB" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
										<asp:label id="lblSupplierBName" runat="server" Visible="False"></asp:label>
									</div>
									<asp:CheckBox id="chbSupBNotFound" runat="server" Text=" New?" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;
									<asp:textbox id="txtSupplierB" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Supplier Name" Autopostback="True" Visible="False"></asp:textbox>
								</p>								
								<p>
									<label class="w3-bar-item w3-left">Supplier C:&nbsp;</label>
									<asp:LinkButton id="btnCreatePOSupC" OnClientClick="return confirm('Are you sure you want to proceed?');" CssClass="w3-btn w3-ripple w3-small w3-round w3-green w3-bar-item w3-right w3-mobile"
										runat="server" Visible="True">&nbsp;Create PO</asp:LinkButton>
									<br>																				
									<div class="dropdown-container">
										<asp:dropdownlist id="ddlSupplierC" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
										<asp:label id="lblSupplierCName" runat="server" Visible="False"></asp:label>
									</div>
									<asp:CheckBox id="chbSupCNotFound" runat="server" Text=" New?" Checked="False" AutoPostBack="True"></asp:CheckBox>&nbsp;
									<asp:textbox id="txtSupplierC" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="Supplier Name" Autopostback="True" Visible="False"></asp:textbox>
								</p>																																			
								<p>
									Note:&nbsp;
								...
								<p>
									<asp:LinkButton id="btnCompleted" OnClientClick="return confirm('Are you sure you want to proceed?');" CssClass="w3-btn w3-ripple w3-small w3-round w3-indigo w3-bar-item w3-mobile"
									runat="server" Visible="True">&nbsp;Tag as completed?</asp:LinkButton>																																									
								</p>									
							</div>							
						</div>						
										...
										<tr>
											<th>
												<asp:datagrid id="DataGrid" runat="server" ShowFooter="True" CellPadding="3" Width="100%" Height="24px"
													...
													BorderStyle="None" ShowHeader="False" CssClass="w3-table-all w3-hoverable">
		...
		<script>                        
			...
			$('#txtForPOQty,#txtVendorCost1,#txtVendorCost2,#txtVendorCost3').attr('inputmode', 'numeric').on('input paste', function(e) {
			...
			$('.myddl').select2({
				...
				selectionCssClass: 'w3-pale-blue w3-medium'								
			});
			...
			$(document).ready(function() {
				$('tr').find('a[href="javascript:__doPostBack(\'DataGrid$ctl02$ctl00\',\'\')"]').remove();
			});
