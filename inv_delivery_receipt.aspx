<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_delivery_receipt.aspx.vb" Inherits="srx.inv_delivery_receipt" %>
	...
	<!-- #include file ="html\BodyColor.html" -->
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Print DR</b></h5>
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">						
							<%
								response.write("<a class='w3-hover-blue' href='inv_delivery_update.aspx'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")
							%>
							<H2 class="w3-center">
								...
								<tr>
									<th>
										<asp:datagrid id="DataGrid" runat="server" ShowFooter="False" CellPadding="3" Width="100%" Height="24px"
											...
											<Columns>
												<asp:ButtonColumn Text="PrintDR" CommandName="PrintDR"></asp:ButtonColumn>
											</Columns>
		...
		<script>
			...
			$(document).ready(function() {
				...
				var printDRLinks = $("td a[href*='__doPostBack']:contains('PrintDR')");				

				// Apply styles for "Approve"
				printDRLinks.css("color", "green");
			});
		</script>
	</body>
</HTML>
