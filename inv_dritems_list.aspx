<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_dritems_list.aspx.vb" Inherits="srx.inv_dritems_list" %>
	...
	<!-- #include file ="html\BodyColor.html" -->
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main">
				...
				<br>
				<!-- Input Form -->		
				<asp:panel id="panelOnProcess" style="Z-INDEX: 99;" runat="server" class="w3-display-left">
					<div class="w3-responsive">
						<TABLE id="tblGroupList" class="w3-table-all w3-hoverable" cellSpacing="0" cellPadding="2"
							border="0">
							<tr>
								<th>
									<asp:datagrid id="Datagrid3" runat="server" ShowFooter="False" CellPadding="3" Width="100%" Height="24px"
										BackColor="White" BorderWidth="1px" BorderColor="#999999" GridLines="Vertical"
										...
										<HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#FF0000"></HeaderStyle>										
							...
							<div class="w3-container">
								<div class="w3-row">
									...
									<asp:panel id="panel2" style="Z-INDEX: 0" runat="server" Visible="False">
										<div class="w3-half">
											<h7><B>On Process</B></h7><BR>
												<asp:label id="lblOnProcessSOH2" runat="server" class="hyperlink"></asp:label>
										</div>
										<div class="w3-half">											
											<h7><B>Available SOH</B></h7><BR>
							...
							<div class="w3-container">
								<div class="w3-row">
									<div class="w3-quarter w3-margin-right">
										...
										<asp:textbox id="txtQty" runat="server" Placeholder="0.00" CssClass="w3-input w3-border amount txtNumbers" onkeypress="return clickButton(event,'btnSave')" required></asp:textbox>
									</div>
									<div class="w3-rest">
										<label></label><BR>
							...
							<div class="w3-container">
								<div class="w3-row">
									<div class="w3-twothird">
										...
										<asp:textbox id="txtSRP" runat="server" Placeholder="0.00" CssClass="w3-input w3-border amount txtNumbers" onkeypress="return clickButton(event,'btnSave')" required></asp:textbox>
										<div style="display:none">
									...
									<div class="w3-third">
										...
										<asp:textbox id="txtDiscount" runat="server" Placeholder="0.00" CssClass="w3-input w3-border amount txtNumbers" onkeypress="return clickButton(event,'btnSave')" required></asp:textbox>
									</div>									
								</div>								
							</div>
							<div class="w3-container">
				...
				<asp:panel id="panelForm2" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4 myForm">
						...
						<DIV class="w3-medium" id="mydivheader">
							...
							<br>
							<div class="w3-container">
								<LABEL><B>SO Qty</B></LABEL>
								<asp:textbox id="txtSOQty" runat="server" CssClass="w3-input txtNumbers" onkeypress="return clickButton(event,'btnSave2')" required></asp:textbox>
							</div>
							<br>
							<div class="w3-container">
								<LABEL><B>UOM</B></LABEL>
								<asp:textbox id="txtSOUOM" runat="server" CssClass="w3-input" onkeypress="return clickButton(event,'btnSave2')" required></asp:textbox>
							</div>
							<br>
							<div class="w3-container">
								<LABEL><B>SO Unit Cost</B></LABEL>
								<asp:textbox id="txtSOUnitCost" runat="server" CssClass="w3-input txtNumbers" onkeypress="return clickButton(event,'btnSave2')" required></asp:textbox>
							</div>
							<br>
							<div class="w3-container">
								<LABEL><B>Remarks</B></LABEL>
								<asp:textbox id="txtNotes" runat="server" CssClass="w3-input w3-border w3-white" TextMode="MultiLine" Maxlength="1000"></asp:textbox>								
							</div>								
						</div>
						...
						<div class="w3-container w3-blue">
							...
							<div class="w3-row w3-text-black">
								<div class="w3-half">									
									...
									<asp:textbox id="txtSINo" runat="server" Width="80%" CssClass="w3-input w3-white w3-border" Placeholder="type here..." Autopostback="True"></asp:textbox>									
								</div>
								<div class="w3-half">									
							...
							<p>
								Terms:&nbsp;
								<asp:textbox id="txtTerms" runat="server" Width="30%" CssClass="w3-input w3-white w3-border txtNumbers" Autopostback="True" required></asp:textbox>
							</p>
							<p>
								VAT Exclusive?
							...
							<div class="w3-row w3-medium w3-text-black">
								...
								<div class="w3-half">										
									...
									<asp:textbox id="txtLessAmount" Width="70%" CssClass="w3-input w3-medium w3-white w3-border txtNumbers" Autopostback="True" runat="server"></asp:textbox>																				
								</div>
							...
							<div class="w3-medium w3-text-black">
								Budget:&nbsp;
								<asp:textbox id="txtBudget" runat="server" CssClass="w3-input w3-white w3-border txtNumbers" Placeholder="type here..." Autopostback="True"></asp:textbox>
							</div>	
							<div class="w3-medium w3-text-black">
								PO No.:&nbsp;
								<asp:textbox id="txtPONo" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="type here..." Autopostback="True"></asp:textbox>
							</div>	
							<div class="w3-row w3-medium w3-text-black">
								Project Name:&nbsp;
								<asp:textbox id="txtProjectDesc" runat="server" CssClass="w3-input w3-white w3-border" Placeholder="type here..." Autopostback="True"></asp:textbox>
							</div>																																									
							<p>
								Note:&nbsp;
				...
				<asp:panel id="panelGrid" style="Z-INDEX: 0;" runat="server" Visible="True">
					...
					<div class="w3-rest w3-padding w3-mobile">																														
						...
						<div style="display:none">							
							...
							<asp:ImageButton id="btnPrintSOImg" runat="server" ImageUrl="images/printbtn.png" Tooltip="Sales Order" CssClass="btnImg w3-bar-item w3-hover-opacity w3-right" />
							<asp:ImageButton id="btnPrintSIImg" runat="server" ImageUrl="images/printbtn.png" Tooltip="Sales Invoice" CssClass="btnImg w3-bar-item w3-hover-opacity w3-right" />
							<asp:ImageButton id="btnPrintImg" runat="server" ImageUrl="images/printbtn.png" Tooltip="DR" CssClass="btnImg w3-bar-item w3-hover-opacity w3-right" />								
						...
						<p>
							...
							<asp:LinkButton id="btnPrintSO" CssClass="w3-btn w3-ripple w3-indigo w3-mobile w3-bar-item w3-right w3-margin-left"
								runat="server"><i class="fas fa-print"></i>&nbsp;Sales Order</asp:LinkButton>
							<asp:LinkButton id="btnPrintSI" CssClass="w3-btn w3-ripple w3-indigo w3-mobile w3-bar-item w3-right w3-margin-left"
								runat="server"><i class="fas fa-print"></i>&nbsp;Sales Invoice</asp:LinkButton>	
							<asp:LinkButton id="btnPrint" CssClass="w3-btn w3-ripple w3-indigo w3-mobile w3-bar-item w3-right w3-margin-left"
								runat="server"><i class="fas fa-print"></i>&nbsp;DR</asp:LinkButton>	
							<asp:LinkButton id="btnPrintQuote" CssClass="w3-btn w3-ripple w3-indigo w3-mobile w3-bar-item w3-right w3-margin-left"
								runat="server"><i class="fas fa-print"></i>&nbsp;Quotation</asp:LinkButton>	
						</p>
						<p style="display:none">
		...
		<script>                        
			...
			$(document).ready(function() {
				$('#panelOnProcess').hide();
				$('#lblOnProcessSOH2').click(function (e) {					
					// Show the panel
					$("#panelOnProcess").show();
					// Set a timeout to hide the panel after 10 seconds
					setTimeout(function() {
						$("#panelOnProcess").hide();
					}, 10000); // 10 seconds
				});
