...
Public Class inv_prequests_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblForApproval As System.Web.UI.WebControls.Label
    Protected WithEvents lblPending As System.Web.UI.WebControls.Label
    Protected WithEvents lblIncomplete As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Public strSubMenuName As String = "inv_prequests_list"
    Public strStoredProc As String = "Inv_PRequests_List"
    Public strStoredProcPageCount As String = "Inv_PRequestPageCount_Get"    
    ...
    Private Sub ClearInputs()
        ...
        calPODate.SelectedDate = DateTime.UtcNow.AddHours(8).ToShortDateString
        calPODate.Enabled = True

        chbDueDate.Checked = False
        chbDueDate.Enabled = True
        ...
        txtCurrentForex.Text = 0
        txtCurrentForex.Enabled = True
    ...
    Private Function Refresh_Boxes()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Inv_PRequestsBox_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        lblForApproval.Text = Trim(objReader("on_process"))
        lblPending.Text = Trim(objReader("approved"))
        lblIncomplete.Text = Trim(objReader("incomplete"))
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                If txtFormAction.Text = "Add" Then
                    ...
                    Response.Redirect("inv_pritems_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_pritems_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
