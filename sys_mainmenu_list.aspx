<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sys_mainmenu_list.aspx.vb" Inherits="srx.sys_mainmenu_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px;">
				...
				<div style="padding-top: 20px; margin-bottom: 50px">
					<h5 class="w3-left"><b><i class="fas fa-warehouse"></i>&nbsp;Main Menu Administration</b></h5>
				</div>				
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0," runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">												
							<%response.write("<a class='w3-hover-blue' href='sys_mainmenu_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
		...
		<script>
			...
			function filterTable(event) {
				...
				for (var i = 0; i < rows.length; i++) {
					...
					if (thirdCol.indexOf(filter) > -1 || fourthCol.indexOf(filter) > -1) {
