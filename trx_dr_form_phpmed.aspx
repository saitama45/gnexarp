<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form_phpmed.aspx.vb" Inherits="srx.trx_dr_form_phpmed" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.vendor_address { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 8em; TOP: 180px }
           
			DIV.pr_code { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; display:none }
            DIV.pr_date { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 145px }
