...
Public Class ref_salestarget_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_salestarget_list"
    Public strStoredProc As String = "ref_salestarget_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_SalesTarget_Get", objConnection)
        ...
        Dim strYear As String = Trim(objReader("year"))

        lblID.Text = objReader("id")

        ddlMonth.SelectedValue = Trim(objReader("month_name"))
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_SalesTarget_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        objCommand.Parameters.Add("@month_name", ddlMonth.SelectedValue)
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_SalesTarget_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@company", ddlCompany.SelectedValue)
        ...
        Try
            ...
            Sys_Class.SaveToAuditTrail(Session("username"), _
                                        ...
                                        strSubMenuName, _
                                        "Year: " + ddlYear.SelectedValue + " > Month: " + ddlMonth.SelectedValue + " > Amount: " + txtAmount.Text, _
                                        objNewID.Value, _
                                        "0")
