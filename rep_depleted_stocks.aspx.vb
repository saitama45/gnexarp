...
Public Class rep_depleted_stocks
...
#End Region
    ...
    Public strSubMenuName As String = "rep_depleted_stocks"
    Public strStoredProc As String = "rep_depleted_stocks"
    Public strSubMenuFullView As String = "rep_depleted_stocks_popup"
    ...
    Public strFileNameExcel As String = "DepletedStocksReport.xls"
    Public strFileNamePDF As String = "DepletedStocksReport.pdf"
