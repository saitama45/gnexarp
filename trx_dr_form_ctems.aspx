<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_dr_form_ctems.aspx.vb" Inherits="srx.trx_dr_form_ctems" %>
...
<HTML>
	<HEAD>
		...
		<style>
            ...
            DIV.vendor_name { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 8em; TOP: 88px }
			DIV.vendor_address { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 8em; TOP: 110px }
           
			DIV.pr_code { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; display:none }
            DIV.pr_date { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 88px }
			...
			DIV.net_sales { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 700px; display:none }
			...
			.cost {
				width: 180px; /* Specify the width for the third column */ display:none
			}
			.netcost {
				width: 180px; /* Specify the width for the third column */ display:none
			}
