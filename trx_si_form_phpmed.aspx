<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_si_form_phpmed.aspx.vb" Inherits="srx.trx_si_form_phpmed" %>
...
<HTML>
	<HEAD>
		...
		<style>
            ...
            DIV.vendor_name { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 7em; TOP: 183px }
			DIV.vendor_address { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 8em; TOP: 213px }
            DIV.tin_no { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 12em; TOP: 230px }

            DIV.invoice_no { FONT-SIZE: 26px; color:red; POSITION: absolute; PADDING-LEFT: 30em; TOP: 80px;display:none }
			DIV.so_no { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; display:none }
			DIV.dr_code { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; display:none }
            DIV.pr_date { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 43em; TOP: 183px }
            DIV.terms { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 43em; TOP: 213px }
			DIV.po_no { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 43em; TOP: 241px; }
	...
	<body>		
		...
		<div class="page-header">				
			...
			<div class="dr_code">
				<asp:label id="lblDRCode" runat="server"></asp:label>
			</div>						
			<div class="pr_date">
