<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_soa_print.aspx.vb" Inherits="srx.rep_soa_print" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.printed_on { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 3em; TOP: 950px }
			DIV.business_name { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 3em; TOP: 150px }			
			DIV.client { FONT-SIZE: 12px; POSITION: absolute;PADDING-LEFT: 3em; TOP: 150px }						
			DIV.address { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 3em; TOP: 90px }
			DIV.tin_no { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 3em; TOP: 110px }
			DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 43em; TOP: 145px }								
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				...
				<div class="business_name">
					Business Name:&nbsp;<asp:label id="lblBusinessName" runat="server"></asp:label>
				</div>
			</asp:panel>
			<asp:panel id="panelClientName" runat="server" Visible="False">
				<div class="client">
					Client Name:&nbsp;<asp:label id="lblClient" runat="server"></asp:label>
				</div>														
			</asp:panel>
			</div>						
