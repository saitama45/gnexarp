...
Public Class ref_venrawmats_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtMinOrder As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents lblContractExpiration As System.Web.UI.WebControls.Label
    Protected WithEvents btnPrintWithNoImg As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Public strStoredProc As String = "ref_venrawmats_list"
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_VenRawMats_Get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        txtMinOrder.Text = objReader("min_order")
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_VenRawMats_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        ...
        objCommand.Parameters.Add("@min_order", txtMinOrder.Text)
        ...
        Try
            ...
            Sys_Class.SaveToAuditTrail(Session("username"), _
                                        ...
                                        Request("sys_table"), _
                                        "VendorCode: " + lblVendorCode.Text + " > RMCode: " + strRMCode + " > UOM: " + strUOM + " > Cost: " + txtCost.Text + " > MinOrder: " + txtMinOrder.Text, _
                                        objNewID.Value, _
                                        0)
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_VenRawMats_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@vendor_code", lblVendorCode.Text)
        objCommand.Parameters.Add("@rm_code", ddlRawMats.SelectedValue)
    ...
    Handles btnSave.Click
        ...
        If txtCost.Text = Nothing Or txtCost.Text.Length > 0 And txtCost.Text.Trim().Length = 0 Then 'txtName.Text.Length > 0 And txtName.Text.Trim().Length = 0 to handle empty and white spaces
    ...
    Sub DisplayHeader()
        ...
        lblVendorCode.Text = objReader("code")
        lblVendor.Text = objReader("name")
        lblContactPerson.Text = objReader("contact")
        lblContactNo.Text = objReader("contact_no")
        lblAddress.Text = objReader("address")
        lblContractExpiration.Text = objReader("contract_expiration")
    ...
    Private Sub btnBackToList_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBackToList.Click
        Response.Redirect("ref_vendors_list.aspx")
    End Sub
