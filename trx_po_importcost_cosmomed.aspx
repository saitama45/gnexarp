<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_po_importcost_cosmomed.aspx.vb" Inherits="srx.trx_po_importcost_cosmomed" %>
	...
	<body>				
		...
		<div class="header">
			...
			<div class="vendor_contactno">
				<LABEL class="header_class">Other Info:</LABEL>
