...
Public Class rep_costofinventories
...
#End Region
    ...
    Public strSubMenuName As String = "rep_costofinventories"
    Public strStoredProc As String = "rep_costofinventories"
    Public strSubMenuFullView As String = "rep_costofinventories_popup"
    ...
    Public strFileNameExcel As String = "CostofInventoriesReport.xls"
    Public strFileNamePDF As String = "CostofInventoriesReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            calDateFrom.SelectedDate = DateSerial(Today.Year, 1, 1)
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        Dim aColumns() As String = {"", _
                                    ...
                                    "soh", _
                                    "landed_cost", _
                                    "cost_of_inventories", _
                                    "hlight"}


        'the headers to diplay, instead of the default fieldname

        Dim aHeaders() As String = {"Voucher Type", _
                                    "Warehouse", _
                                    "Brand", _
                                    "Item Code", _
                                    "Item Desc", _
