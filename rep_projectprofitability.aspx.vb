...
Public Class rep_projectprofitability
...
#End Region
    ...
    Public strSubMenuName As String = "rep_projectprofitability"
    Public strStoredProc As String = "rep_projectprofitability"
    Public strSubMenuFullView As String = "rep_projectprofitability_popup"
    ...
    Public strFileNameExcel As String = "ProjectProfitabilityReport.xls"
    Public strFileNamePDF As String = "ProjectProfitabilityReport.pdf"
