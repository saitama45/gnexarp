<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_issuance_list.aspx.vb" Inherits="srx.inv_issuance_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;Sales Order</b></h5>
				</div>
				<!-- End Header -->
							...
							<div class="w3-row">
								<div class="w3-half">
									<div class="w3-container">
										...
										<asp:dropdownlist tabIndex="3" id="ddlClient" runat="server" CssClass="w3-tag w3-input w3-border w3-pale-blue w3-mobile myddl" AutoPostback="True" required></asp:dropdownlist>
									</div>
								</div>
								<div class="w3-half">
									<div class="w3-container">
