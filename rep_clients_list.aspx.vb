...
#End Region
    ...
    Public strSubMenuName As String = "rep_clients_list"
    Public strStoredProc As String = "rep_clients_list"
    Public strSubMenuFullView As String = "rep_clients_list_popup"
    ...
    Public strFileNameExcel As String = "CustomersListReport.xls"
    Public strFileNamePDF As String = "CustomersListReport.pdf"
