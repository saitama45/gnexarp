...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lstCity As System.Web.UI.WebControls.ListBox
    Protected WithEvents lstIndustry As System.Web.UI.WebControls.ListBox
    Protected WithEvents lstRegion As System.Web.UI.WebControls.ListBox
...
#End Region
    ...
    Public strSubMenuName As String = "rep_vendors_list"
    Public strStoredProc As String = "rep_vendors_list"
    Public strSubMenuFullView As String = "rep_vendors_list_popup"
    ...
    Public strFileNameExcel As String = "SuppliersListReport.xls"
    Public strFileNamePDF As String = "SuppliersListReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'get the list of BU
            Dim objCommand As New SqlCommand("Ref_Industry_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@Session_username", Session("username"))
            Dim objReader As SqlDataReader = objCommand.ExecuteReader
            lstIndustry.DataSource = objReader
            lstIndustry.DataValueField = "name"
            ...
            lstCity.DataSource = objReader
            lstCity.DataValueField = "name"
            lstCity.DataTextField = "name"
            lstCity.DataBind()
            objReader.Close()

            objCommand = New SqlCommand("Ref_Regions_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objReader = objCommand.ExecuteReader
            lstRegion.DataSource = objReader
            lstRegion.DataValueField = "name"
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        Catvalue = "0"
        For Each item As ListItem In lstIndustry.Items
        ...
        SubCatValue = "0"
        For Each item As ListItem In lstCity.Items
            If item.Selected Then
        ...
        RegionValue = "0"
        For Each item As ListItem In lstRegion.Items
            If item.Selected Then
                RegionValue = RegionValue + IIf(RegionValue <> "", ",", "") + item.Value
                selected = selected + 1
            End If
        Next
        ...
        objCommand.Parameters.Add("@industry", Catvalue)
        objCommand.Parameters.Add("@city", SubCatValue)
        objCommand.Parameters.Add("@region", RegionValue)
        objCommand.Parameters.Add("@Session_username", Session("username"))
    ...
    Private Sub btnFullView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFullView.Click
        ...
        SetEndPopup(strSubMenuFullView & "?industry=" & Catvalue & _
                    " &city=" & SubCatValue & _
                    " &region=" & RegionValue & _
                    " &title=" & lblTitle.Text)
