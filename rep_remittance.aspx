<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_remittance.aspx.vb" Inherits="srx.rep_remittance" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Remittance Report" runat="server" ForeColor="Red"
				...
				<p>									
					<div class="w3-row w3-section">
						<div class="w3-quarter" style="display:none;">
							<div class="w3-col s6" style="WIDTH:100px">Brand:</div>
							<asp:listbox id="lstBrand" runat="server" CssClass="lstItems" SelectionMode="Multiple"></asp:listbox>
						</div>
						<div class="w3-quarter" style="display:none;">
							<div class="w3-col s6" style="WIDTH:100px">Items:</div>
							<asp:listbox id="lstItems" runat="server" CssClass="lstItems" SelectionMode="Multiple"></asp:listbox>
						</div>								
						<div class="w3-quarter" style="display:none;">
							<div class="w3-col s6" style="WIDTH:100px">BU:</div>
							<asp:listbox id="lstBU" runat="server" CssClass="lstItems" SelectionMode="Multiple"></asp:listbox>
						</div>
						<div class="w3-quarter" style="display:none;">
							<div class="w3-col s6" style="WIDTH:100px">Sales Person:</div>
							<asp:listbox id="lstSalesPerson" runat="server" CssClass="lstItems" SelectionMode="Multiple"></asp:listbox>
						</div>									
					</div>										
				<P></P>
				<hr>
