<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_pos_list.aspx.vb" Inherits="srx.inv_pos_list" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-BOTTOM: 50px; PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-file-invoice"></i>&nbsp;POS</b></h5>
				</div>
				<!-- End Header -->
				...
				<div class="w3-row-padding w3-margin-bottom">					
					<div class="w3-third">
					  <div class="w3-container w3-blue w3-padding-16 w3-card-4">
						<div class="w3-left">
							<h4><b>SALES FOR TODAY</b></h4>
						</div>						
						<div class="w3-clear"></div>
						<div class="w3-center">
							<h4><asp:label id="lblSalesToday" runat="server"></asp:label></h4>
						</div>
					  </div>
					</div>
					<div class="w3-third">
					  <div class="w3-container w3-teal w3-padding-16 w3-card-4">
						<div class="w3-left">
							<h4><b>CASH ON HAND</b></h4>
						</div>						
						<div class="w3-clear"></div>
						<div class="w3-center">
							<h4><asp:label id="lblCASH" runat="server"></asp:label></h4>
						</div>
					  </div>
					</div>					
					<div class="w3-third">
						<div class="w3-container w3-orange w3-text-white w3-padding-16 w3-card-4">
						  <div class="w3-left">
							  <h4><b>EXPENSES</b></h4>
						  </div>						
						  <div class="w3-clear"></div>
						  <div class="w3-center">
						  	<h4><asp:label id="lblExpenses" runat="server"></asp:label></h4>
						  </div>
						</div>
					  </div>
				</div>
