...
Public Class rep_account_receivables
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lstARBy As System.Web.UI.WebControls.ListBox
...
#End Region
    ...
    Public strSubMenuName As String = "rep_account_receivables"
    Public strStoredProc As String = "rep_account_receivables"
    Public strStoredProc2 As String = "rep_ar_monthly"
    Public strSubMenuFullView As String = "rep_account_receivables_popup"
    ...
    Public strFileNameExcel As String = "ARReport.xls"
    Public strFileNamePDF As String = "ARReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            calDateFrom.SelectedDate = "1/1/2000"
            calDateTo.SelectedDate = DateTime.UtcNow.AddHours(8)
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        If lstARBy.SelectedValue = "DetPerAccountName" Then
        ...
        ElseIf lstARBy.SelectedValue = "MonPerAccountName" Then
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        If lstARBy.SelectedValue = "DetPerAccountName" Then
            Dim aColumns() As String = {"client", _
                                        "invoice_no", _
                                        "si_date", _
                                        "net_sales", _
                                        "paid_amount", _
    ...
    Private Sub lstARBy_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstARBy.SelectedIndexChanged
        If lstARBy.SelectedValue = "DetPerAccountName" Then
