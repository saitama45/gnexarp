...
Public Class trx_po_receiving_jezhan
...
#End Region
    ...
    Public strStoredProc As String = "Inv_PrintPreview_ReceivingPO"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblReceivedDate.Text = objReader("pr_date")
            lblVendorName.Text = objReader("vendor_name")
            lblVendorCode.Text = objReader("vendor_dr_no")
            lblTerms.Text = objReader("terms")
            lblDiscount.Text = objReader("discount_show")
            lblNetPOAmount.Text = objReader("net_amount_show")
            ...
            If Convert.IsDBNull(objReader("vendor_si_no")) Then
                lblEmail.Text = ""
            Else
                lblEmail.Text = objReader("vendor_si_no")
            End If
            ...
            Else
                lblVendorContactNo.Text = objReader("note")
            End If
            ...
            'objCommand.CommandType = CommandType.StoredProcedure
            'objCommand.Parameters.Add("@pr_code", Request("code"))
            'objReader = objCommand.ExecuteReader
            ...
            '        Dim tblRow3 As New TableRow
            '        Dim tblCell3 As New TableCell
            '        Dim tblRow4 As New TableRow
            '        Dim tblCell4 As New TableCell
            '        Dim tblRow5 As New TableRow
            '        Dim tblCell5 As New TableCell

            '        tblCell.Text = objReader("rm_name")
            '        tblCell2.Text = objReader("uom")
            '        tblCell3.Text = objReader("qty")
            '        tblCell4.Text = objReader("cost")
            '        tblCell5.Text = objReader("total_cost")

            '        tblRow.Cells.Add(tblCell)
            '        tblRMName.Rows.Add(tblRow)

            '        tblRow2.Cells.Add(tblCell2)
            '        tblUOM.Rows.Add(tblRow2)

            '        tblRow3.Cells.Add(tblCell3)
            '        tblQty.Rows.Add(tblRow3)

            '        tblRow4.Cells.Add(tblCell4)
            '        tblCost.Rows.Add(tblRow4)

            '        tblRow5.Cells.Add(tblCell5)
            '        tblTotalCost.Rows.Add(tblRow5)
