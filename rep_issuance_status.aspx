<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_issuance_status.aspx.vb" Inherits="rasa.rep_issuance_status" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="PADDING-TOP: 20px">
					<h5 class="w3-left"><b><i class="fas fa-project-diagram"></i>&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Issuance Status Report" runat="server" ForeColor="Red"
