<%@ Page Language="vb" AutoEventWireup="false" Codebehind="inv_receivingdtl_nonpob.aspx.vb" Inherits="ems.inv_receivingdtl_nonpob" %>
					...
					<DIV id="id01" class="w3-card-4 myForm">
						...
						<DIV class="w3-medium" id="mydivheader">
							...
							<asp:panel id="panelRPO" style="Z-INDEX: 0" runat="server" Visible="False">
								...
								<div class="w3-row">
									<div class="w3-half">
										<P><LABEL><B>P.O. Qty</B></LABEL>
											<asp:label id="lblPOQty" runat="server"></asp:label>
										</P>
									</div>
									<div class="w3-half">
										<P><LABEL><B>P.O. Cost</B></LABEL>
					...
					<div class="w3-third">
						<div class="w3-container w3-blue">
							...
							<p>
								...
								<asp:textbox tabIndex="5" id="txtDiscount" runat="server" CssClass="w3-input w3-border txtNumbers" Placeholder="0.00" AutoPostback="True" required></asp:textbox>
							</p>
							<p style="display:none">
								Total Cost:&nbsp;
