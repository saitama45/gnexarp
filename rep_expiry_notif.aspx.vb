...
#End Region
    ...
    Public strSubMenuName As String = "ref_expiry_notif"
    Public strStoredProc As String = "rep_expiry_notif"
    Public strSubMenuFullView As String = "rep_expiry_notif_popup"
    ...
    Public strFileNameExcel As String = "ItemLevelReport.xls"
    Public strFileNamePDF As String = "ItemLevelReport.pdf"
