...
#End Region
    ...
    Public strSubMenuName As String = "ref_level_notif"
    Public strStoredProc As String = "rep_level_notif"
    Public strSubMenuFullView As String = "rep_level_notif_popup"
