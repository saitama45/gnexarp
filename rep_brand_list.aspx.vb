...
#End Region
    ...
    Public strSubMenuName As String = "rep_brand_list"
    Public strStoredProc As String = "rep_brand_list"
    Public strSubMenuFullView As String = "rep_brand_list_popup"
    ...
    Public strFileNameExcel As String = "BrandListsReport.xls"
    Public strFileNamePDF As String = "BrandListsReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            'get the list of BU
            Dim objCommand As New SqlCommand("Ref_Brand_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            Dim objReader As SqlDataReader = objCommand.ExecuteReader
            lstIndustry.DataSource = objReader
            lstIndustry.DataValueField = "code"
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        objCommand.Parameters.Add("@brand", Catvalue)
