...
Public Class ref_safetylevelitems_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtSLID As System.Web.UI.WebControls.TextBox
    Protected WithEvents txtSLValue As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Public strStoredProc As String = "ref_safetylevelitems_list"
    Public strSubMenuName As String = "ref_safetylevelitems_list"
    ...
    Private Sub LoadGrid()
        ...
        While objReader.Read
            ...
            myItems &= ("<tr>" & _
                            ...
                            "</td>" & _
                            "<td class='txtSafetyLevel'>" & _
                                "<input type='text' class='safetylevel' value='" + Trim(objReader("safety_level")) + "'>" & _
                            "</td>" & _
                            "<td>" & _
                                Trim(objReader("critical_level")) & _
                            "</td>" & _
                        "</tr>")
    ...
    Private Sub btnBackImg_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnBackImg.Click
        Response.Redirect("ref_safetylevel_list")
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim objCommand As New SqlCommand("Ref_SafetyLevelItems_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure

        objCommand.Parameters.Add("@id", txtSLID.Text)
        objCommand.Parameters.Add("@safety_level", txtSLValue.Text)
