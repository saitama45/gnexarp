...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lblTinNo As System.Web.UI.WebControls.Label
    Protected WithEvents panelBusinessName As System.Web.UI.WebControls.Panel
    Protected WithEvents panelClientName As System.Web.UI.WebControls.Panel
...
#End Region
    ...
    Public strFileNameExcel As String = "StatementOfAccount.xls"
    Public strFileNamePDF As String = "StatementOfAccount.pdf"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim objCommand As New SqlCommand("Ref_ClientsSOA_Get", objConnection)
            ...
            If Request("business_name") <> "0" Then

                objCommand.Parameters.Add("@businessname", Request("business_name"))
                objCommand.Parameters.Add("@client", "")
                objCommand.Parameters.Add("@Session_username", Session("username"))

                'lblBusinessName.Text = Request("business_name")
                panelBusinessName.Visible = True
                panelClientName.Visible = False

            ElseIf Request("customer") <> "0" Then

                objCommand.Parameters.Add("@businessname", "")
                objCommand.Parameters.Add("@client", Request("customer"))
                objCommand.Parameters.Add("@Session_username", Session("username"))

                'lblClient.Text = Request("customer")
            ...
            lblBusinessName.Text = objReader("branch")
            lblClient.Text = objReader("name")
            lblAddress.Text = objReader("address")
            lblTinNo.Text = objReader("tin_no")
            ...
            objCommand.Parameters.Add(strSPParam_Value1, Request("customer"))
            objCommand.Parameters.Add(strSPParam_Value2, Request("business_name"))
