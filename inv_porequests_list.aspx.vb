...
Public Class inv_porequests_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents panelApprove As System.Web.UI.WebControls.Panel
    Protected WithEvents lblModeApprove As System.Web.UI.WebControls.Label
    Protected WithEvents txtFormActionApprove As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblIDApprove As System.Web.UI.WebControls.Label
    Protected WithEvents lblCustomerApprove As System.Web.UI.WebControls.Label
    Protected WithEvents lblCustomerCodeApprove As System.Web.UI.WebControls.Label
    ...
    Protected WithEvents btnSaveApprove As System.Web.UI.WebControls.Button
    Protected WithEvents btnCancelApprove As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Public strSubMenuName As String = "inv_porequests_list"
    Public strStoredProc As String = "inv_porequests_list"
    Public strStoredProc2 As String = "inv_porequestsdtl_list"
    Public strStoredProcPageCount As String = "Inv_PORequestsPageCount_Get"
    ...
    Handles btnSave.Click
        ...
        If strValidateInput = "ok" Then
            ...
            If strSaveInput = "ok" Then
                ...
                Response.Redirect("inv_porequestsdtl_list?&id=" & Session("objNewID") & "&sys_table=" & strStoredProc)
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_porequestsdtl_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)
        ...
        If e.CommandName = "Approve" Then
            ...
            txtFormActionApprove.Text = "Approve"
            lblModeApprove.ForeColor = Color.Green

            'show the Form panel
            Sys_Class.ReadyForm(panelApprove, _
                                panelSuccess, _
                                panelInfo, _
                                lblMessage, _
                                ValidationSummary1, _
                                lblModeApprove, _
                                txtFormActionApprove)
    ...
    Private Function ReadyApprove()
        ...
        Dim bolChangeable As Boolean = Trim(objReader("status")) = "PENDING" And Trim(objReader("total_requested_qty")) <> 0

        lblIDApprove.Text = Trim(objReader("id"))

        lblSONo.Text = Trim(objReader("so_no"))
        lblStatus.Text = Trim(objReader("status"))
        lblCustomerApprove.Text = Trim(objReader("customer_name"))
        lblCustomerCodeApprove.Text = Trim(objReader("customer"))
        lblPRNo.Text = Trim(objReader("por_code"))
        lblPRDate.Text = Trim(objReader("por_date"))
        lblRequestedBy.Text = objReader("requested_by")
        lblDueDate.Text = Trim(objReader("due_date"))
        lblNote.Text = Trim(objReader("note"))

        btnSaveApprove.Visible = bolChangeable
        btnCancelApprove.Visible = bolChangeable
    ...
    Private Sub btnSaveApprove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveApprove.Click
        ...
        objCommand.Parameters.Add("@id", strKeyFieldValue)
        objCommand.Parameters.Add("@Session_fullname", Session("username"))
