<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ref_clients_list.aspx.vb" Inherits="srx.ref_clients_list" %>
...
<HTML>
	...
	<body class="w3-light-grey">
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">						
					<asp:ImageButton id="btnBackImg" runat="server" ImageUrl="images/backarrow.png" Tooltip="Back To References" CssClass="backImg w3-hover-opacity" Visible="False"/>
					<b class="w3-medium">&nbsp;Customers</b>																				
				</div>
				<!-- End Header -->
				...
				<asp:panel id="panelForm" style="Z-INDEX: 0" runat="server" Visible="False">
					<DIV id="id01" class="w3-card-4" style="margin: auto;MAX-WIDTH: 600px">
						<HEADER class="w3-container w3-light-grey w3-display-container w3-responsive">
							<%response.write("<a class='w3-hover-blue' href='ref_clients_list'><span class='w3-button w3-large w3-hover-red w3-display-topright'>x</span></a>")%>
							<H2 class="w3-center">
						...
						<DIV class="w3-container w3-section w3-medium">
							...
							<P style="display:none"><LABEL><B>Client Code</B></LABEL><BR>
								<asp:textbox id="txtClientCode" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox>
							</P>
							<P><LABEL><B>Business Name</B></LABEL><BR>
								<asp:textbox id="txtBranch" runat="server" Width="100%" Placeholder="Type here..." required></asp:textbox>
							</P>
							<P><LABEL><B>Customer Group</B></LABEL><BR>
								<asp:dropdownlist id="ddlCGroup" runat="server" Width="100%" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl"></asp:dropdownlist>
							</P>
							<P><LABEL><B>Tin #</B></LABEL><BR>
								<asp:textbox id="txtTin" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox>
							</P>
							...
							<P><LABEL><B>Billing Address</B></LABEL><BR>
								<asp:textbox id="txtAddress" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox>
							</P>
							<P><LABEL><B>Delivery Address</B></LABEL><BR>
								<asp:textbox id="txtDeliveryAddress" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox>
							</P>
							...
							<P><LABEL><B>Terms (How many Days?)</B></LABEL><BR>
								<asp:textbox id="txtTerms" runat="server" Width="100%" Placeholder="Type here..."></asp:textbox>
							</P>
							<P><LABEL><B>Client Since</B></LABEL><BR>
								<ew:calendarpopup id="calClientSince" style="Z-INDEX: 0" runat="server" VisibleDate="2015-11-13"
							...
							<div>
								<P><LABEL><B>Pricing</B></LABEL><BR>								
									<asp:dropdownlist id="ddlPricing" runat="server" CssClass="w3-tag w3-input w3-pale-blue w3-mobile myddl">
							...
							<P><LABEL><B>Discount (%)</B></LABEL><BR>
								<asp:textbox id="txtDiscount" runat="server" Width="100%" CssClass="w3-input" Placeholder="Type here..."></asp:textbox>
							</P>
						</DIV>
		...
		<script>
			...
			$("#calClientSince").keyup(function (e) {
