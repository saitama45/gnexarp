...
Public Class inv_payments_list
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents calSODate As eWorld.UI.CalendarPopup
...
#End Region
    ...
    Public strSubMenuName As String = "inv_payments_list"
    Public strStoredProc As String = "inv_payments_list"
    Public strStoredProcPageCount As String = "Inv_PaymentsPageCount_Get"
...
Handles MyBase.Load
    ...
    Private Sub DataGrid_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid.ItemCommand
        ...
        If e.CommandName = "Open" Then
            ...
            Response.Redirect("inv_paymentdtl_list?&id=" & strKeyFieldValue & "&sys_table=" & strStoredProc)

        End If
    End Sub
    Protected Sub UploadSO(ByVal sender As Object, ByVal e As EventArgs)
        Dim csvPath As String = Server.MapPath("~/Uploads/") + "uploadedAR.txt"
        ...
        If (Not FileUploadSO.PostedFile Is Nothing) AndAlso (FileUploadSO.PostedFile.ContentLength > 0) Then
            ...
            Try
                ...
                Dim objConnection As New SqlConnection(ConfigurationSettings.AppSettings("appConn"))
                Dim objCommand As New SqlCommand("upl_ImportARCSV", objConnection)
                objCommand.CommandType = CommandType.StoredProcedure
                ...
                Else
                    ...
                    objCommand = New SqlCommand("Ref_ARUpload_Validate2", objConnection)
                    objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function ValidateUpload()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_ARUpload_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function SaveUpload()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_ARUpload_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
