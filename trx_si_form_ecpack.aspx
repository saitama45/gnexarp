<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_si_form_ecpack.aspx.vb" Inherits="srx.trx_si_form_ecpack" %>
...
<HTML>
	<HEAD>
		...
		<style>
            ...
            DIV.vendor_name { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 12em; TOP: 140px }
			DIV.vendor_address { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 12em; TOP: 170px }
			...
			DIV.so_no { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; }
			DIV.po_no { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 12em; TOP: 680px; }
			DIV.pr_code { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 40em; TOP: 90px; display:none }
            DIV.pr_date { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 50em; TOP: 140px }
            DIV.terms { FONT-SIZE: 14px; POSITION: absolute; PADDING-LEFT: 50em; TOP: 170px }
