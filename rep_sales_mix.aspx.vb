...
#End Region
    ...
    Public strSubMenuName As String = "rep_sales_mix"
    Public Rep_SalesMix_SKU As String = "Rep_SalesMix_SKU"
    Public Rep_SalesMix_Brand As String = "Rep_SalesMix_Brand"
    Public Rep_SalesMix_Category As String = "Rep_SalesMix_Category"
    Public Rep_SalesMix_SubCategory As String = "Rep_SalesMix_SubCategory"
    ...
    Public strFileNameExcel As String = "SalesMixReport.xls"
    Public strFileNamePDF As String = "SalesMixReport.pdf"
    ...
    Private Function GetCommandBySelectedValue(ByVal connection As SqlConnection) As SqlCommand
        ...
        Select Case lstSalesBy.SelectedValue
            Case "SalesMixSKU"
                objCommand = New SqlCommand(Rep_SalesMix_SKU, connection)
            Case "SalesMixBrand"
                objCommand = New SqlCommand(Rep_SalesMix_Brand, connection)
            Case "SalesMixCategory"
                objCommand = New SqlCommand(Rep_SalesMix_Category, connection)
            Case "SalesMixSubCategory"
                objCommand = New SqlCommand(Rep_SalesMix_SubCategory, connection)            
        End Select
    ...
    Private Sub lstSalesBy_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstSalesBy.SelectedIndexChanged
        ...
        If lstSalesBy.SelectedValue = "SalesMixSKU" Then
        ...
        ElseIf lstSalesBy.SelectedValue = "SalesMixBrand" Then
        ...
        ElseIf lstSalesBy.SelectedValue = "SalesMixCategory" Then
            lblItem.Visible = False
            lstItem.Visible = False
        ...
        ElseIf lstSalesBy.SelectedValue = "SalesMixSubCategory" Then
            lblItem.Visible = False
            lstItem.Visible = False
