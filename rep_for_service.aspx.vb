...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lstService As System.Web.UI.WebControls.ListBox
...
#End Region
    ...
    Public strSubMenuName As String = "ref_for_service"
    Public strStoredProc As String = "rep_for_service"
    Public strSubMenuFullView As String = "rep_for_service_popup"
    ...
    Public strFileNameExcel As String = "DueForMaintenanceReport.xls"
    Public strFileNamePDF As String = "DueForMaintenanceReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim objCommand As New SqlCommand("Ref_Clients_Get_droplist", objConnection)
    ...
    Sub GridBind()
        ...
        If strSubMenuName <> Session("Current_Module") Then
            Session("Current_Module") = strSubMenuName
            Session("SortKey") = strDefaultSortKey
        End If

        Sys_Class.BindGrid_SetDisplay_v2(dgList, _
                                    strSubMenuName, _
                                    Session("username"), _
                                    Session("SortKey"), _
                                    strKeyField, _
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        ServiceValue = "0"
        For Each item As ListItem In lstService.Items
            If item.Selected Then
                ServiceValue = ServiceValue + IIf(ServiceValue <> "", ",", "") + item.Value
                selected = selected + 1
            End If
        Next
        ...
        objCommand.Parameters.Add("@customer", Catvalue)
        objCommand.Parameters.Add("@asset", SubCatValue)
        objCommand.Parameters.Add("@service", ServiceValue)
        objCommand.Parameters.Add("@Session_username", Session("username"))
