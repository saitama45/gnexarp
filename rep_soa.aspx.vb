...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents rdoAccount As System.Web.UI.WebControls.RadioButtonList
    ...
    Protected WithEvents panelAccountName As System.Web.UI.WebControls.Panel
    Protected WithEvents panelBusinessName As System.Web.UI.WebControls.Panel
...
#End Region
    ...
    Public strSubMenuName As String = "rep_soa"
    Public strStoredProc As String = "rep_soa"
    Public strSubMenuFullView As String = "rep_soa_print"
    ...
    Public strFileNameExcel As String = "SOAReport.xls"
    Public strFileNamePDF As String = "SOAReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            calDateFrom.SelectedDate = "1/1/2022"
            ...
            lstCategories.DataValueField = "name"
            lstCategories.DataTextField = "name"
            lstCategories.DataBind()
            objReader.Close()

            'get the list of BusinessName
            objCommand = New SqlCommand("Ref_BusinessName_Get_droplist", objConnection)
            objCommand.CommandType = CommandType.StoredProcedure
            objCommand.Parameters.Add("@Session_username", Session("username"))
            objReader = objCommand.ExecuteReader
            lstBusinessName.DataSource = objReader
            lstBusinessName.DataValueField = "code"
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        If panelAccountName.Visible = True Then
            objCommand.Parameters.Add("@customer", lstCustomer.SelectedValue)
        Else
            objCommand.Parameters.Add("@customer", 0)
        End If

        If panelBusinessName.Visible = True Then
            objCommand.Parameters.Add("@business_name", lstBusinessName.SelectedValue)
        Else
            objCommand.Parameters.Add("@business_name", 0)
        End If
    ...
    Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        If panelBusinessName.Visible = True Then
            ...
            SetEndPopup(strSubMenuFullView & _
                "?&business_name=" & lstBusinessName.SelectedValue & _
                "&customer=" & "0" & _
                "&date_from=" & calDateFrom.SelectedDate & _
                "&date_to=" & calDateTo.SelectedDate & _
                "&title=" & lblTitle.Text)

        ElseIf panelAccountName.Visible = True Then

            SetEndPopup(strSubMenuFullView & _
                "?&business_name=" & "0" & _
                "&customer=" & lstCustomer.SelectedValue & _
                "&date_from=" & calDateFrom.SelectedDate & _
                "&date_to=" & calDateTo.SelectedDate & _
                "&title=" & lblTitle.Text)
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        Dim aColumns() As String = {"business_name", _
                                    "customer", _
                                    "invoice_no", _
                                    "si_date", _
                                    "delivery_date", _
    ...
    Private Sub rdoAccount_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles rdoAccount.SelectedIndexChanged
        If rdoAccount.SelectedValue = 0 Then
            panelBusinessName.Visible = True
            panelAccountName.Visible = False
        Else
            panelBusinessName.Visible = False
            panelAccountName.Visible = True
        End If
    End Sub
