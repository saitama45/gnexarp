...
Public Class sys_mainmenu_list
...
#End Region
    ...
    Public strStoredProc As String = "sys_mainmenu_list"
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Sys_MainMenu_Get", objConnection)
        ...
        txtMainMenuName.Text = Trim(objReader("name"))
        txtMainMenuName.Enabled = True

        txtMainMenuCode.Text = Trim(objReader("code"))
        txtMainMenuCode.Enabled = True

        txtSortOrder.Text = Trim(objReader("sort_order"))
