...
Public Class rep_incomestatement
...
#End Region
    ...
    Public strSubMenuName As String = "rep_incomestatement_print"
    Public strStoredProc As String = "Rep_IncomeStatement"
    Public strSubMenuFullView As String = "rep_incomestatement_popup"
    ...
    Public strFileNameExcel As String = "IncomeStatementReport.xls"
    Public strFileNamePDF As String = "IncomeStatementReport.pdf"
