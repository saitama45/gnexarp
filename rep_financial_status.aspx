<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_financial_status.aspx.vb" Inherits="srx.rep_financial_status" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 40px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium"><asp:label id="lblTitle" runat="server" ForeColor="Red" CssClass="w3-bar-item">Financial Status Report</asp:label></b>
				</div>
				<!-- End Header -->				
				<hr class="w3-bottombar w3-border-deep-purple">
					<div class="w3-row w3-section">
						<div class="w3-third">
							...
							<asp:listbox id="lstARBy" runat="server" SelectionMode="Single" CssClass="ddl">
						...
						<div class="w3-third" style="display:none">
							<div class="w3-col" style="WIDTH:100px">Delivered Date To:</div>
								<div class="w3-rest">									
				...
				<p>
					<div class="w3-row w3-section">
						...
						<div class="w3-third">
							...
							<asp:listbox id="lstCustomer" runat="server" CssClass="ddl" SelectionMode="Single"></asp:listbox>
						</div>				
					</div>
				<P></P>
				<hr>
