<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_received_stocks.aspx.vb" Inherits="srx.rep_received_stocks" %>
		...
		<FORM id="Form1" style="FONT: menu" method="post" runat="server">
			...
			<div id="main" class="w3-container w3-main" style="MARGIN-TOP: 43px">
				...
				<div style="MARGIN-TOP: 15px;">										
					...
					<b class="w3-medium">&nbsp;<asp:label id="lblTitle" style="Z-INDEX: 0" text="Received Stocks Report" runat="server" ForeColor="Red"
				...
				<p>
					<div class="w3-row">
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">Received Date From:</div>
								<div class="w3-rest">
						...
						<div class="w3-third w3-section">
							<div class="w3-col" style="WIDTH:100px">Received Date To:</div>
								<div class="w3-rest">
				...
				<p>									
					<div class="w3-row w3-section">
						...
						<div class="w3-quarter">
							<div class="w3-col s6" style="WIDTH:100px">Suppliers:</div>
							<asp:listbox id="lstSuppliers" runat="server" CssClass="lstItems" SelectionMode="Multiple"></asp:listbox>
						</div>										
					</div>										
				<P></P>
				<hr>
