<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_receivingWOPO_form.aspx.vb" Inherits="srx.trx_receivingWOPO_form" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.received_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 62em; TOP: 89px; display:none }
			...
			DIV.vendor_contact { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 140px; display:none }
			
			DIV.vendor_address { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 16em; TOP: 160px }
						
			DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 2em;}
		...
		<form id="Form1" runat="server">
			...
			<div class="page-header">
				<div class="image_header">
					<img src="./images/receivingWOPOform.jpg" alt="receivingWOPOform" class="img_background" >
						...
						<td>
							<div class="page">
								...
								<div class="datagrid">
									...
									<div class="discounted_amount" style="display:none">
