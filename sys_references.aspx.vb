...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents spanProducts As System.Web.UI.HtmlControls.HtmlGenericControl
...
#End Region
    ...
    Public strSubMenuName As String = "sys_references"
    Public strStoredProc As String = "sys_references"
    ...
    Private Sub LoadReferences()
        ...
        Dim objCommand As New SqlCommand("sys_references_get", objConnection)
        ...
        objCommand = New SqlCommand("sys_references_get", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure

        objCommand.Parameters.Add("@sys_group", Session("Group"))
        objCommand.Parameters.Add("@header", "PRODUCTS")

        objReader = objCommand.ExecuteReader

        Dim myProducts As String = String.Empty
        ...
        spanProducts.InnerHtml = myProducts
