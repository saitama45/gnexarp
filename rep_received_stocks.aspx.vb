...
Public Class rep_received_stocks
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lstSuppliers As System.Web.UI.WebControls.ListBox
...
#End Region
    ...
    Public strSubMenuName As String = "rep_received_stocks"
    Public strStoredProc As String = "rep_received_stocks"
    Public strSubMenuFullView As String = "rep_received_stocks_popup"
    ...
    Public strFileNameExcel As String = "ReceivedStocksReport.xls"
    Public strFileNamePDF As String = "ReceivedStocksReport.pdf"
    ...
    Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            objCommand.Parameters.Add("@Session_username", Session("username"))
            objReader = objCommand.ExecuteReader
            lstSuppliers.DataSource = objReader
            lstSuppliers.DataValueField = "code"
    ...
    Private Sub btnGenerate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        SubCatValue = "0"
        For Each item As ListItem In lstSuppliers.Items
            If item.Selected Then
        ...
        objCommand.Parameters.Add("@item", Catvalue)
        objCommand.Parameters.Add("@brand", BrandValue)
        objCommand.Parameters.Add("@vendor", SubCatValue)
    ...
    Private Sub btnFullView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFullView.Click
        ...
        SetEndPopup(strSubMenuFullView & "?item=" & Catvalue & _
                    " &vendor=" & SubCatValue & _
                    " &title=" & lblTitle.Text)
    ...
    Private Sub dgList_ItemCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgList.ItemCreated
        ...
        Dim aHeaders() As String = {"Item Code", _
                                    "Barcode", _
                                    "Brand", _
                                    "Item Desc", _
                                    "Lot#/Serial#", _
