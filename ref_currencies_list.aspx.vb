...
Public Class ref_currencies_list
...
#End Region
    ...
    Public strSubMenuName As String = "ref_currencies_list"
    Public strStoredProc As String = "ref_currencies_list"
   ...
   Handles DataGrid.EditCommand
    ...
    Private Sub ReadyEdit()
        ...
        Dim objCommand As New SqlCommand("Ref_Currencies_Get", objConnection)
        ...
        txtSymbol.Text = Trim(objReader("symbol"))
    ...
    Private Sub ReadyDelete()
        ...
        txtCode.Text = objReader("code")
        txtSymbol.Text = objReader("symbol")
    ...
    Private Function ValidateInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Currencies_Validate", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Function SaveInput()
        ...
        'the stored procedure and parameters
        Dim objCommand As New SqlCommand("Ref_Currencies_Save", objConnection)
        objCommand.CommandType = CommandType.StoredProcedure
        objCommand.Parameters.Add("@FormAction", txtFormAction.Text)
        objCommand.Parameters.Add("@id", lblID.Text)
        objCommand.Parameters.Add("@name", txtName.Text)
        objCommand.Parameters.Add("@code", txtCode.Text)
        objCommand.Parameters.Add("@symbol", txtSymbol.Text)
