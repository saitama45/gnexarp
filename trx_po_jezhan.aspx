<%@ Page Language="vb" AutoEventWireup="false" Codebehind="trx_po_jezhan.aspx.vb" Inherits="srx.trx_po_jezhan" %>
...
<HTML>
	<HEAD>
		...
		<style>
			...
			DIV.pr_code { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 50em; TOP: 145px }
			DIV.pr_date { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 50em; TOP: 165px }
			DIV.terms { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 50em; TOP: 185px }

			DIV.vendor_name { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 1em; TOP: 145px }
			DIV.vendor_contact { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 165px }
			DIV.vendor_contactno { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 185px }
			DIV.email { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 205px }			
			DIV.vendor_address { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 225px }

			DIV.requested_by { FONT-SIZE: 12px; FONT-WEIGHT: bold; POSITION: absolute; PADDING-LEFT: 50em; TOP: 205px }
			DIV.note { FONT-SIZE: 12px; POSITION: absolute; PADDING-LEFT: 1em; TOP: 245px }
